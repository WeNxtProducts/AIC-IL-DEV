...
//END
	...
	public void setCOMP_POL_PREM_OPTION_LABEL(
			HtmlOutputLabel cOMP_POL_PREM_OPTION_LABEL) {
...
/*added by Sankaranarayanan on 27-03-2017 for ssp call id - ZBILQC-1721052*/
		...
		/*Added by saritha on 17-08-2017 for ssp call id ZBILQC-1735415 as per Thiag sir sugg*/
	...
	public void setListItemValues() {
		...
		try {
			...
			/*added by saranya on 10-12-2016 for RM018T - FSD_IL_ZB Life_016-Queried Proposals v1.0*/
			setListPOL_CANCEL_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
					"PT_IL_POLICY.POL_FLEX_27", "YESNO"));
			/*End*/

			setListPOL_FRZ_FLAG(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
					"PT_IL_POLICY.POL_FRZ_FLAG", "YESNO"));

			setListPOL_CASH_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_CASH_YN",
					"YESNO"));

			/*added by gopi for RM018T - DEV_IL_ZB Life_022-Automated Premium Loan on 06/01/17*/
			setListPOL_APL_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_APL_YN",
					"YESNO"));
			//end
		setListPOL_MODE_OF_CALC(ListItemUtil.getDropDownListValue(
			...
			setListPOL_STD_SUBSTD(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
					"PT_IL_POLICY.POL_STD_SUBSTD",
					"StandardcaseSubstandard case"));

			/*
			 * modified by Ameen on 12-10-2017 as per Chandramohan said
			 * setListPOL_PYMT_TYPE(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
			...
			setListPOL_CREDIT_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
					"PT_IL_POLICY.POL_CREDIT_YN", "YESNO"));

			setListPOL_STAFF_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
					"PT_IL_POLICY.POL_STAFF_YN", "YESNO"));

			setListPOL_FAC_BASIS(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY",
			...
			setListPOL_FAC_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_FAC_YN",
					"YESNO"));

			setListPOL_CQS_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_CQS_YN",
					"YESNO"));
			...
			setListPOL_ESC_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002T", "PT_IL_POLICY", "PT_IL_POLICY.POL_ESC_YN",
					"ESC_APP_YN"));

			setListPOL_FLEX_14(ListItemUtil.getDropDownListValue(connection,
					"PILT002T", "PT_IL_POLICY", "PT_IL_POLICY.POL_FLEX_14",
					"ESC_APP"));

			setListPOL_FLEX_09(ListItemUtil.getDropDownListValue(connection,
					"PILT002T", "PT_IL_POLICY", "PT_IL_POLICY.POL_FLEX_09",
					"ESC_APP_INT"));
			/*Added by saranya for RM018T - FSD_IL_ZB Life_001-Education Endowment Plan COMMENTS on 26-01-2017*/	
			setListPOL_ANN_PAY_PERIOD(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_ANN_PAY_PERIOD",
					"IL_ANN_PAY"));
			
			setListPOL_BNF_ESC_PERC(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_BNF_ESC_PERC",
					"IL_BNF_ESC"));
			
			setListPOL_UL_PREM_CALC(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC", "PT_IL_POLICY", "PT_IL_POLICY.POL_UL_PREM_CALC",
					"IL_UL_PRMCAL"));
			...
			setListPOL_LAPS_OVR_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_LAPS_OVR_YN","YESNO"));
			
			/*End*/
			/*Added by saranya for RM018T - DEV_IL_ZB Life_027-Replacement Policy on 17-03-2017*/
			setListPOL_REPL_POLICY_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_REPL_POLICY_YN","YESNO"));
			/*End*/

			
			/*Added by sankaranarayanan  for ZBILQC-1721052 27-03-2017*/
			setListPOL_DISPATCH_MTD(ListItemUtil.getDropDownListValue(
					connection, "PILT002_APAC", "PT_IL_POLICY",
		...
		/*end*/
			...
			setListPOL_RETURN_VAL(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_RETURN_VAL","IL_UL_CLM_VL"));
			/*Added by Sivarajan on 12-08-2018 for KICLIFEQC-1761314 */
			setListENDORSEMENT_TYPE(getLIV_CODE());
			/*added by Ameen on 21-10-2019 for SARWA sugg. by Vijay and Manoj*/
			setListPOL_BNF_ESC_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_REPL_POLICY_YN","YESNO"));
			
			setListPOL_ADHOC_PREM_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_REPL_POLICY_YN","YESNO"));
			
			setListPOL_CASHBACK_YN(ListItemUtil.getDropDownListValue(connection,
					"PILT002_APAC","PT_IL_POLICY","PT_IL_POLICY.POL_REPL_POLICY_YN","YESNO"));
			/*END*/
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void setCOMP_POL_FC_AGENT_PREM_lABEL(
			HtmlOutputLabel cOMP_POL_FC_AGENT_PREM_lABEL) {
	...
	public void setCOMP_POL_LC_AGENT_PREM_lABEL(
			HtmlOutputLabel cOMP_POL_LC_AGENT_PREM_lABEL) {
	...
	public void setCOMP_UI_M_POL_LC_TOT_LOADING1(
			HtmlInputText COMP_UI_M_POL_LC_TOT_LOADING1) {
	...
	public void setCOMP_POL_ENDORSEMENT_TYPE_LABEL(
			HtmlOutputLabel cOMP_POL_ENDORSEMENT_TYPE_LABEL) {
	...
	public String deleteRow(ActionEvent event) {
		...
		try {
			if (isDELETE_ALLOWED()) {
				...
				new CRUDHandler().executeDelete(PT_IL_POLICY_BEAN, CommonUtils
						.getConnection());
				getWarningMap().put(
						"deleteRow",
						Messages.getString(
	...
	public void saveRecord() throws Exception{
		/*System.out.println("getPOL_PREM_OPTION_CODE "+PT_IL_POLICY_BEAN.getPOL_PREM_OPTION_CODE());*/

		compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getCOMP_REPORT_MODAL_PANEL_ASSURED().setRendered(false);
		
		/*Added by ganesh to avoid popuping busrule modal panel on save button on 09-08-2017*/
		...
		try {
			...
			/*Added by saritha on 16-04-2018 for KIC Customer address Details to default policy level address
			 *Handled for below scenario
			 *1.New customer creation choose any 
			 *Communication Address to default Policy level Communication Address
			 *2.Communication Address to allow change in address
			 *3.Change in Address Endorsement passing customer address should not default policy level communication address
			 *only to allow change in address.*/ 
			...
			if(addrEnableDisableParam.equalsIgnoreCase("1")){
				...
				/*if(PT_IL_POLICY_BEAN.getPOL_END_CODE()!=null &&!PT_IL_POLICY_BEAN.getPOL_END_CODE().equalsIgnoreCase("GEN002")){*/
				if(PT_IL_POLICY_BEAN.getPOL_END_CODE()!=null &&!CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_END_CODE(),"GEN002","GEN015")){
		   ...
		   /*End*/
			...
			System.out.println("PLAN_TYPE            "+PLAN_TYPE+"       getProd_unit_link_type       "+PT_IL_POLICY_BEAN.getProd_unit_link_type()+"     getPOL_ANN_PAY_PERIOD   "+PT_IL_POLICY_BEAN.getPOL_ANN_PAY_PERIOD());
			...
			System.out.println("getPOL_PYMT_TYPE                   "+PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE());
			 ...
			 /*Added by saritha on 22-11-2017 for Due date for debit order by each policy is required*/ 
			if(PT_IL_POLICY_BEAN.getPOL_DEBIT_DAY()==null && PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AD")){
			...
			//if(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("S") && !PT_IL_POLICY_BEAN.getPOL_MODE_OF_PYMT().equalsIgnoreCase("M"))
			
			if((PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("S") || PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AO"))
			...
			/*End*/
			{
				...
				throw new Exception(Messages.getString(
						PELConstants.pelErrorMessagePath, "2314"));
								
				//throw new Exception("Payment type Stop order is applicable only for Mode of Payment:Monthly");
			}
			else
			{
			...
			try{
			 lifelib.P_VAL_CUST(PT_IL_POLICY_BEAN.getPOL_CONT_CODE(),
		...
		//	helper.assuredAgeCheck(compositeAction);
			...
			System.out.println("getPT_IL_POLICY_BEAN().getPOL_PREM_PAY_YRS()         "+getPT_IL_POLICY_BEAN().getPOL_PREM_PAY_YRS()+"     "+
					getPT_IL_POLICY_BEAN().getPOL_PERIOD());
			
			/*Added by Ram on 26/11/2016 for Policy Period validation handling*/
			...
			if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FC_SUM_ASSURED()!=null){
				double SUM_ASSURED=compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FC_SUM_ASSURED();
				...
				if(SUM_ASSURED>getsm)
				{
					...
					System.out.println("manditary field if part value:"+compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().getPT_IL_DOC_TODO_LIST_STATUS_BEAN().getDTLS_MANDATORY_YN());

				}
				else
				{
					new PT_IL_DOC_TODO_LIST_STATUS_DELEGATE().updatemandatoryflag(compositeAction,"N",Todo);
					System.out.println("manditary field else part value:"+compositeAction.getPT_IL_DOC_TODO_LIST_STATUS_ACTION_BEAN().getPT_IL_DOC_TODO_LIST_STATUS_BEAN().getDTLS_MANDATORY_YN());
				}
			...
			Commented by Saranya on 07/04/2017
				...
				throw new Exception(" FC Sum Assured :Validation Error: Value is required.");
			}
			End
			*/

			/*Added by sankara narayanan for uicomponent frz flag on 21-03-2017*/
			compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().setPOL_FRZ_FLAG(CommonUtils.nvl(PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG(),"N"));
			//end
			
			
			

			//added by agalya on 10/07/2016 for ssp call no -FALCONQC-1714573
			String POL_FRZ_FLAG=compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FRZ_FLAG();
			System.out.println("POL_FRZ_FLAG in save button========>"+POL_FRZ_FLAG);
			String POL_DS_TYPE=compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE();
			System.out.println("POL_DS_TYPE in save button==========>"+POL_DS_TYPE);
			String POL_PROP_QUOT_FLAG=compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_PROP_QUOT_FLAG();
			System.out.println("POL_PROP_QUOT_FLAG in save button==========>"+POL_PROP_QUOT_FLAG);
			Integer POL_END_NO_IDX=compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_END_NO_IDX();
			System.out.println("POL_END_NO_IDX ::::::INter"+POL_END_NO_IDX);
			//Added by Dhinesh on 19-06-2017
			/*if(POL_FRZ_FLAG.equalsIgnoreCase("Y")&& POL_DS_TYPE.equals("1")&& POL_PROP_QUOT_FLAG.equalsIgnoreCase("P"))*/
			if(POL_FRZ_FLAG.equalsIgnoreCase("Y")&& POL_DS_TYPE.equals("1")&& POL_PROP_QUOT_FLAG.equalsIgnoreCase("P") && "A".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FAC_BASIS()))
			{
				...
				String query = "SELECT PC_SYS_ID, PC_SCHD_PYMT_DT  FROM PT_IL_PREM_COLL, PT_IL_POLICY WHERE PC_POL_SYS_ID = POL_SYS_ID AND POL_DS_TYPE = 1 AND PC_POL_SYS_ID ='"+pol_sys_id+"'";
				...
				if(flag==false)
				{
				PKG_PILT002_APAC_BEAN.callpolicyreviewsheet( String.valueOf(pol_sys_id),String.valueOf(PC_SYS_ID),CommonUtils.dateToStringFormatter(PC_SCHD_PYMT_DT),freeze,values);
				}
			}
			//Added by Ameen 30-7-2016 as per Siva said to call procedure P9ILPK_RI_ALLOC.P_APPRV_FAC if ds_type=2 and IDX_NO=0 

			PKG_PILT002_APAC PKG_PILT002_APAC_BEAN=new PKG_PILT002_APAC();

			if(POL_FRZ_FLAG.equalsIgnoreCase("Y")&& POL_DS_TYPE.equals("2")&& POL_PROP_QUOT_FLAG.equalsIgnoreCase("P") && POL_END_NO_IDX==0 && "A".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FAC_BASIS()))
			{
				System.out.println("POL_DS_TYPE 2 inside the proceduce");

				/*Instance Object creation place changed by Ramkumar on 06-08-2016 for Cover default Date change issue
				 * 
				 * PKG_PILT002_APAC PKG_PILT002_APAC_BEAN=new PKG_PILT002_APAC();*/
				...
				System.out.println("value of pol_sys_id in premiajasperprint"+pol_sys_id);
				String query = "SELECT PC_SYS_ID, PC_SCHD_PYMT_DT  FROM PT_IL_PREM_COLL, PT_IL_POLICY WHERE PC_POL_SYS_ID = POL_SYS_ID AND POL_DS_TYPE = 2 AND PC_POL_SYS_ID ='"+pol_sys_id+"'";
				System.out.println("query exe sucess"+query);	     	     
				resultSet = new CRUDHandler().executeSelectStatement(query, con);
				System.out.println("value for insert"+	handler.executeSelectStatement(query, con));
				while (resultSet.next()) {
			...
			/*Condition Added by Ameen on 18/11/2016 for Endorsement Cancellation*/
		/*
		 * 
		 ...
		 * 	if(!"009".equalsIgnoreCase(getPT_IL_POLICY_BEAN().getPOL_END_TYPE())){
			...
			if(!"009".equalsIgnoreCase(getPT_IL_POLICY_BEAN().getPOL_END_TYPE()) && CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_NO_IDX(),0) > 0 ){
				chkSumAssured();
		}
			/* End */
			/*End*/
			...
			/*Added by saritha on 12-07-2017 for Endowment Product &Education Product Issues*/
			Endow_Product();
			/*End*/
			}
			/*End*/
			/*Commented by ganesh on 02-11-2017, as suggested by girish sir no validation required in save button*/
			/*Added by Ameen on 30-10-2017 for bank details defaulting issue*/
			/*if("AD".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE()) || "BS".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE())){
				bankAccDtlsCheck();
			}*/
			/*End*/
			/*end*/
			/*added by Ameen on 02-10-2018 as per Ajay sugg.
			 * issue :for FLA/VLA to set POL_CUST_EXCH_RATE = 1 as default if 0 to avoid divisor equal to 0 error
			 * */
			if(PT_IL_POLICY_BEAN.getPOL_CUST_EXCH_RATE() == null || PT_IL_POLICY_BEAN.getPOL_CUST_EXCH_RATE() == 0 || PT_IL_POLICY_BEAN.getPOL_CUST_EXCH_RATE() == 0.0){
			...
			if (getPT_IL_POLICY_BEAN().getROWID() != null) {
				if (isUPDATE_ALLOWED()) {
					...
					helper.POL_CONT_CODE_WHEN_VALIDATE_ITEM(compositeAction,(String) PT_IL_POLICY_BEAN.getPOL_CONT_CODE());
					...
					System.out.println("getPOL_FC_AGENT_PREM              "+PT_IL_POLICY_BEAN.getPOL_FC_AGENT_PREM());
					
					list = new P9ILPK_POLICY_NR().P_UPD_PREM_FLAG_NEW(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID(),
					...
					new CRUDHandler().executeUpdate(PT_IL_POLICY_BEAN,
							CommonUtils.getConnection());
					// dummy_action.keycommitButtonAction();
					helper.POST_UPDATE(PT_IL_POLICY_BEAN,
							compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN(),compositeAction);
					
					System.out.println("getPOL_FLEX_20               "+PT_IL_POLICY_BEAN.getPOL_FLEX_20());
					
					helper.updateThresholdLimit(PT_IL_POLICY_BEAN,compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN());
					...
					Integer pol_prd=CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_ORG_PERIOD(),0)+PT_IL_POLICY_BEAN.getPOL_PERIOD() ;
					//if("012".equalsIgnoreCase(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_TYPE(),"000"))){
					if ((CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_ORG_PREM_PAY_YRS(),0)+ PT_IL_POLICY_BEAN.getPOL_PREM_PAY_YRS())> 
					(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_ORG_PERIOD(),0)+ PT_IL_POLICY_BEAN.getPOL_PERIOD())) {
						throw new Exception(Messages.getString(
								PELConstants.pelErrorMessagePath, "91014",
								new Object[] {
										"Premium Paying Years",
				    ...
				    /*Added by saritha on 01-Feb-2018 Feneral Plan(207) Dependant save Record inserted &updated null error as per siva sir sugg.*/
					if(PT_IL_POLICY_BEAN.getPOL_OLD_ASSRD_REF_ID()!=null && !PT_IL_POLICY_BEAN.getPOL_OLD_ASSRD_REF_ID().equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1())){
				...
				if (isINSERT_ALLOWED()) {
					...
					if ("F".equals(compositeAction
							.getDUMMY_ACTION_BEAN().getDUMMY_BEAN().getUI_M_COVER_SA_CALC())) {
					...
					ResultSet freezRS=new CRUDHandler().executeSelectStatement(freezQuery, CommonUtils.getConnection(), 
					...
					new CRUDHandler().executeInsert(PT_IL_POLICY_BEAN,
							CommonUtils.getConnection());
				...
				/*	end*/
					...
					new P9ILPK_POLICY_NR().P_INS_ADDL_COVER(
							...
							compositeAction
							.getDUMMY_ACTION_BEAN().getDUMMY_BEAN().getUI_M_CHANGE_SA_YN());
					/*end*/ 
					...
					String Benef_cust_flag =getBeneficiary_as_customer();
					 if(Benef_cust_flag!=null && "Y".equalsIgnoreCase(Benef_cust_flag)){
						 System.out.println("P9ILPK_POLICY_NR().P_BENEFICIARY_DETAILS PROCEDURE EXECUTED SUCCESSFULLY");
					...
					/*Added by Saranya on 13-03-2017 for RM018T - FSD_IL_ZB Life_001-Education Endowment Plan COMMENTS*/
		 ...
		 * 
		 * PKG_PILT002_APAC_BEAN.P_POL_COV_DT_DFT(getPT_IL_POLICY_BEAN().getPOL_SYS_ID().toString());
			...
			/*
			 * Newly added the below code To avoid the popup is opening on save 
			 */
			...
			if("012".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_TYPE())&& "N".equalsIgnoreCase(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS(),"N")))
			{
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_MODE_OF_PYMT().setDisabled(true);
			}
			
			//added by Ameen as per Somnath Suggestion for Endorsement Cancellation
			System.out.println("P_PRORATE_CAN_ENDORS POL_END_TYPE    : "+getPT_IL_POLICY_BEAN().getPOL_END_TYPE());
			if("009".equalsIgnoreCase(getPT_IL_POLICY_BEAN().getPOL_END_TYPE()))
			{
				System.out.println("inside POL_END_TYPE 009");
				PKG_PILT002_APAC_BEAN.callP_PRORATE_CAN_ENDORS(getPT_IL_POLICY_BEAN().getPOL_SYS_ID(),getPT_IL_POLICY_BEAN().getPOL_END_CODE());
			}
			
			P9ILPK_POLICY P9ILPK_POLICY_OBJ = new P9ILPK_POLICY();
			ArrayList<OracleParameter>  outputList = new ArrayList<OracleParameter>();
			System.out.println("compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID()  update    "
			...
			{
				outputList = P9ILPK_POLICY_OBJ.UPDATE_ASSRD_TH_LT_FOR_POLICY(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID().toString());	
			}
			/*Added by Ram on 23/11/2016 for Endorsement Cancellation value onload*/
			...
			if(compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().getDataList_PT_IL_POL_BENEFICIARY().size()>0)
			{
			...
			/*Commented by ganesh on 19-09-2017 and it is moved at the last of the saverecord method for ZBILQC-1732146*/
			/*getWarningMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY,
					message);
			getWarningMap().put("SAVE_RECORD", message);*/
			/*end*/
			
			/*Added by saranya for for RM018T - FSD_IL_ZB Life_001-Education Endowment Plan COMMENTS on 20-04-2017*/
			/*setPremiumCalculationType();*/
			
			/*Modified by saritha on 01-08-2017 for Endowment Product & Education Product issues*/
			setPremiumCalcType();
			/*End*/
			
			Unit_link_typ();
			if((!"NA".equalsIgnoreCase(getUnit_link_typ()))&&("N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_UL_PREM_CALC()))){
				/*getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY, "NOT A VALID OPTION");*/
			...
			resultset2 = handler1.executeSelectStatement(C3, conn,
					new Object[] {});
			...
			resultset3 = handler1.executeSelectStatement(C4, conn,
					new Object[] {});
			...
			{
			if(("Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()))&&(SUM_ASSURED>DTL_SA_FROM)&&(SUM_ASSURED<DTL_SA_TO)){
			String emailStatusMessage = Email_Procedure_Call.emailStatusMsg(product_code,"FIN1",String.valueOf(pol_sys_id),"C","");;
			...
			{
			if(("Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()))&&(SUM_ASSURED>SA_FROM)&&(SUM_ASSURED<SA_TO)){
			String emailStatusMsg = Email_Procedure_Call.emailStatusMsg(product_code,"FIN2",String.valueOf(pol_sys_id),"C","");;
			...
			if("Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG())){
				new P9ILPK_POLICY().INS_MEDEX_FEE_DTL(
			...
			if (("Y".equalsIgnoreCase(CommonUtils.nvl(
					PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG(), "X")) && CommonUtils
					.nvl(PT_IL_POLICY_BEAN.getPOL_START_DT(), new Date())
					.after(new Date()))) {
				
				futureDateMailMsg = Email_Procedure_Call.emailStatusDynamicMsg(PT_IL_POLICY_BEAN.getPOL_PROD_CODE(), "FDI", PT_IL_POLICY_BEAN.getPOL_SYS_ID().toString(), "C", "");
				System.out.println(futureDateMailMsg);
				
			}
			
			System.out.println("getPOL_LC_SUM_ASSURED         "+PT_IL_POLICY_BEAN.getPOL_LC_SUM_ASSURED()+"     getPOL_FC_SUM_ASSURED     "+PT_IL_POLICY_BEAN.getPOL_FC_SUM_ASSURED());
	...
	//		PT_IL_POLICY_BEAN.setPOL_FC_SUM_ASSURED(PT_IL_POLICY_BEAN.getPOL_LC_SUM_ASSURED());
			...
			//end
			 ...
			 PM_IL_PLAN planObj= helper.doGetPlanType(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_PROD_CODE());
			 ...
			 if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FRZ_FLAG().equalsIgnoreCase("Y")){
				 ...
				 if(fundAllocatedPercentageTotal != 100.00 && (liqVariable.equalsIgnoreCase("liquidPresent")) && planObj.getPLAN_TYPE().equals("U")){
						throw new Exception("Kindly add fund details with 100 % allocation");
					}else if(fundAllocatedPercentageTotal == 100.00 && liqVariable.equalsIgnoreCase("liquidNotPresent") && planObj.equals("U")){
	 ...
	 public void fireFieldValidationFrzFlag(ActionEvent actionEvent) {
			...
			System.out.println("inside fireFieldValidationFrzFlag frzVal >>>> " + frzVal);
			 if(frzVal!=null && !frzVal.equalsIgnoreCase("Y")){
				/* Newly Added By Dhinesh on 11.8.2017 for ssp call id : ZBILQC-1733134 */ 
	...
	public String flagAction(){
		...
		/*
		 * condition modified by Ameen on 18-07-2017 for ZBILQC-1731923 as per Siva sugg.
		 * if(value.equals("Y")){*/
		try{
		/*if("1".equals(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE())){*/
		...
		/*}else{
		//if(value.equals("Y") && "A".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_APPRV_STATUS())){
			if(value.equals("Y") && printBtnFlag){
				...
				System.out.println(" inside DS = 2 if FRZ = N ");
				COMP_POL_PRINT.setDisabled(true);
				COMP_POL_PRINT1.setDisabled(true);
				COMP_POL_RES_EMAIL_ID.setDisabled(false);
	...
	public void setCOMP_POL_BNF_ESC_PERC_LABEL(
			HtmlOutputLabel cOMP_POL_BNF_ESC_PERC_LABEL) {
	...
	public void setCOMP_POL_ANN_PAY_PERIOD_LABEL(
			HtmlOutputLabel cOMP_POL_ANN_PAY_PERIOD_LABEL) {
	...
	public void onLoad(PhaseEvent event) {
		try {
			...
			/*
String  isprmcalc = CommonUtils.nvl(CommonUtils.getGlobalVariable("GLOBAL.ISPRMCALC"),null);	

			if("TRUE".equalsIgnoreCase(isprmcalc))
			{
				System.out.println("******** INSIDE THE isprmcalc IF BLOCK ********* ");
				System.out.println("*5555*");
				compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_KEY_COMMIT().setDisabled(true);	
			}
			 */
			/*ADDED BY RAJA ON 15-03-2017*/
			if(CommonUtils.getGlobalVariable("GLOBAL.CALL_QUERY")!=null && CommonUtils.getGlobalVariable("GLOBAL.CALL_QUERY").equalsIgnoreCase("QUERY"))
			{
			...
			if (isFormFlag()) {
				// CommonUtils.clearMaps(this);
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getErrorMap()
				.clear();
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getWarningMap()
				.clear();
				...
				pilt002_apac_helper
				.PILT002_APAC_WHEN_NEW_FORM_INSTANCE(compositeAction);
				...
				/*if(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS().equalsIgnoreCase("A")&&PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equalsIgnoreCase("Y"))
			{
				System.out.println("inside prem dtls enable");
			compositeAction.getWizard().enableWizardItem("PILT002_APAC_PT_IL_PREM_DTLS");
			}*/
			...
			if (isBlockFlag()) {
				...
				/*End*/
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getCOMP_REPORT_MODAL_PANEL_ASSURED().setRendered(true);
				//compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(true);
				/*End*/
				
				/*Added by R. Raja on 20-12-2016 for RM018T - FSD_IL_ZB Life_002-Customer Master Changes COMMENTS*/
				...
				else
				{
					...
					/*Added by saritha on 13-04-2018 for KIC Customer address Details to defalut policy level address*/
				...
				/*added by raja on 17-08-2017 for RI page policy no getting existing policy*/
			
				CommonUtils.setGlobalVariable("GLOBAL.M_POL_NO", PT_IL_POLICY_BEAN
						.getPOL_NO());
				CommonUtils.setGlobalVariable("GLOBAL.M_POL_CONT_CODE", PT_IL_POLICY_BEAN
						.getPOL_CONT_CODE());
				compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().disableAllComponent(true);
				
				/*end*/
				
				/* Newly Added By Dhinesh on 30-04-2018 for policy owner id issue  */
				...
				/*if(PT_IL_POLICY_BEAN.getPOL_DS_TYPE()!=null && PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("1"))
				{
				COMP_POL_CUST_CODE_LABEL.setValue("Proposer Code");
				}
				else
				{
				...
				/*Commented by ganesh on 28-07-2017,ZBILQC-1731155 as suggested by siva sir changed statically */
				/*Added by saritha on 14-May-2017 for ssp call id ZBILQC-1724959*/
				/*if((PT_IL_POLICY_BEAN.getROWID()==null)||(PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("1")))
				{
				COMP_POL_CUST_CODE_LABEL.setValue("Proposer Code");
				}
				else if(PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("2"))
				{
				COMP_POL_CUST_CODE_LABEL.setValue("Policy Holder Code");
				}*/
				 ...
				 * compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_KEY_COMMIT().setDisabled(
				 * false); disableAllComponent(false); }
				 */
				...
				if (PT_IL_POLICY_BEAN.getROWID() != null) {
					...
					if (compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN()
						...
						{
							PT_IL_POLICY_BEAN.setUI_M_MAT_AGE(compositeAction
					...
					System.out.println("getPOL_DS_TYPE                :"+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE());
					System.out.println("getPOL_APPRV_STATUS                :"+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_APPRV_STATUS());
					System.out.println("getUI_M_POL_PLAN_TYPE                :"+compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN().getUI_M_POL_PLAN_TYPE());

					/*handled nvl by ganesh on 05-07-2017,ZBILQC-1718714*/
					if (CommonUtils.nvl(compositeAction.getDUMMY_ACTION_BEAN()
							.getDUMMY_BEAN().getUI_M_POL_PLAN_TYPE(),"X").equalsIgnoreCase("u")
							&& compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE().equals("2") 
						...
						.getCOMP_UI_M_BUT_FUND_QUERY().setDisabled(
								false);
						compositeAction.getDUMMY_ACTION_BEAN()
						.getCOMP_UI_M_BUT_FUND_QUERY().setRendered(true);
					}else{
						compositeAction.getDUMMY_ACTION_BEAN()
					...
					/*Added By Dhinesh for  ssp call id FALCONLIFE_1349311 on 19.10.2016*/  
				...
				//added by akash to solve the altertion of term endorsment issue

				/*if(!"000".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_TYPE(),"000") )){
					if(!"012".equals(PT_IL_POLICY_BEAN.getPOL_END_TYPE()) ){
						COMP_POL_PERIOD.setDisabled(true);
						///COMP_POL_PREM_PAY_YRS.setDisabled(true);
					}else{
				...
				{*/
				/*Added by saranya on 07-12-2016 for RM018T - FSD_IL_ZB Life_013_Underwriting changes*/ 
				/*if("075".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_SRC_OF_BUS()) && !"KIC/".equalsIgnoreCase(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")))*//*KIC condition handled by Ameen on 26-03-2018 for agent prem. less thencalculated prem. error not to come in KIC*/
				...
				//}
				/*End*/
				/*added by saranya on 20-12-2016 for RM018T - FSD_IL_ZB Life_016-Queried Proposals v1.0*/
				System.out.println("POL_DS_TYPE   :"+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE());
				/*if("2".equals(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE()))
				{
				...
				if((PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equals("1"))&&(PT_IL_POLICY_BEAN.getPOL_NO()!=null)&&(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equals("N")))
				{
					COMP_POL_CANCEL_YN.setDisabled(false);
				}
				else {
				...
				/*Added by saritha on 31-01-2017 for Source Of Business default Broker/Agent*/
				Connection connection = null;
				ResultSet resultset = null;
				connection = CommonUtils.getConnection();
				String PC_DESC=null;
				...
				if(PT_IL_POLICY_BEAN.getROWID()==null){
					...
					}else{//else added by Ameen on 13-07-2018 as per Ajay sugg.
					...
					/*Modified by Janani on 30.06.2018 for Fidelity as suggested by Vinoth*/
					 ...
					 * if(!"NA".equalsIgnoreCase(getUnit_link_typ()))
					{						
						PT_IL_POLICY_BEAN.setPOL_UL_PREM_CALC("D");
					}
					End
					else if("NA".equalsIgnoreCase(getUnit_link_typ()))
					{
						PT_IL_POLICY_BEAN.setPOL_UL_PREM_CALC("N");
					}*/
					
					System.out.println("POL_UL_PREM_CALC / GLOBAL.M_PARAM_8" + CommonUtils.getGlobalVariable("GLOBAL.M_PARAM_8"));
				...
				/*Added by saritha on 20-Jun-2017 for ssp call id ZBILQC-1720514*/

				if(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()!=null && PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equalsIgnoreCase("N"))
				{
					System.out.println("PYMT_TYPE  : "+CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE(), "AD","BS","S","AO"));

					/*Modified by Janani on 27.06.2018 for FLA as per Chandramohan sugges*/
					//if(CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE(), "AD","BS","S"))
					...
					{
						compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_EMPLOYER_CODE_LABEL().setValue("Bank Code");	
					}

					/*Modified by Janani on 27.06.2018 for FLA as per Chandramohan sugges*/
					//else if(CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE(), "S"))
					
					else if(CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE(), "S","AO"))
					/*End*/
					{
						compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_EMPLOYER_CODE_LABEL().setValue("Employer Code");	

					}

					else {
						compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_EMPLOYER_CODE_LABEL().setValue("Employer/Bank Code");
				...
				if((PT_IL_POLICY_BEAN.getROWID()==null)&&("N".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN
						.getPOL_FRZ_FLAG(), "N")))&&("N".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN
				...
				/*Modified by saritha on 25-07-2017 for ssp call id ZBILQC-1732436*/
				...
				ResultSet rs13 = new CRUDHandler().executeSelectStatement(busRuleQuery, CommonUtils.getConnection(), values);
				if (rs13.next()) {
				...
				if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_DS_TYPE().equalsIgnoreCase("1")){
					...
					{*/
					Lap_ovr_sys_param();
					if(("001".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_TYPE())) && (PT_IL_POLICY_BEAN.getPOL_END_CODE()).equalsIgnoreCase(getLap_ovr_sys_param()))
					{
					/*End*/
				...
				//uncommented the below 3 lines due to facing issue in RSA-DSA print button not working.
				if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID()!=null){
					System.out.println("compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID().toString()    : "+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID().toString());
					CommonUtils.setGlobalVariable("GLOBAL.POL_SYS_ID", compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID().toString());
					System.out.println(CommonUtils.getGlobalVariable("GLOBAL.POL_SYS_ID"));
				}

				//added by agalya for premiumn details link enable & disable on 03-06-2016
				if(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS().equalsIgnoreCase("A")&&PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equalsIgnoreCase("Y"))
				{				
					compositeAction.getWizard().enableWizardItem("PILT002_APAC_PT_IL_PREM_DTLS");
				}		
				...
				/* added by R. Raja for RM018T - FSD_IL_ZB Life_010-Maximum Funeral  Benefit Limit*/ 

				/*Commenetd by Saranya on 11/04/2017 
			getProd_plan_type();
			 End*/
				...
				/*END*/
				/*Added by saranya for RM018T - FSD_IL_ZB Life_001-Education Endowment Plan COMMENTS on 01-02-2017
			if(("U".equalsIgnoreCase(PLAN_TYPE)) && (!"N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_BNF_ESC_PERC())))
			{
				PT_IL_POL_ESC_SA_ACTION_BEAN.getCOMP_UI_M_BUT_ANNU_ESC().setRendered(true);
			}
			else{
				PT_IL_POL_ESC_SA_ACTION_BEAN.getCOMP_UI_M_BUT_ANNU_ESC().setRendered(false);
			}
			End*/

				/*added by raja on 10-05-2017*/

				if (null == PT_IL_POLICY_BEAN.getPOL_FLEX_20()
						|| PT_IL_POLICY_BEAN.getPOL_FLEX_20().isEmpty()
				...
				//if(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE()!=null && PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AD"))
				...
				/*Added by Ameen on 14-03-2018 for KIC*/
					...
					ResultSet excessRS = new CRUDHandler().executeSelectStatement("SELECT PROD_REG_EXCESS_APP_YN,PROD_MAT_AMT_LEVEL FROM PM_IL_PRODUCT WHERE PROD_CODE = ?", 
				...
				if (null == PT_IL_POLICY_BEAN.getPOL_FLEX_20()
					...
					.getCOMP_POL_FRZ_FLAG().setDisabled(true);
				} else if (!"A".equalsIgnoreCase(PT_IL_POLICY_BEAN
						.getPOL_APPRV_STATUS())) {
					compositeAction.getPT_IL_POLICY_ACTION_BEAN()
				...
				if ("A".equalsIgnoreCase(compositeAction.getDUMMY_ACTION_BEAN()
						.getDUMMY_BEAN().getUI_M_APPRV_STATUS())) {
					if (compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN()
							.getUI_M_POL_NO() == null) {
						compositeAction.getDUMMY_ACTION_BEAN()
						.getCOMP_UI_M_BUT_CONVERT().setDisabled(false);
					} else {
						compositeAction.getDUMMY_ACTION_BEAN()
						.getCOMP_UI_M_BUT_CONVERT().setDisabled(true);
					}
				}
				...
				/*
				 * As per Vinoth requirement, no need to display endorsment letter link in this screen.
				 *  commented by ganesh on 21-07-2016 
				 * 
				 */
				/*if (CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_NO_IDX(),0) > 0 && 
						"A".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_STATUS(),"N"))) {
				getCOMP_UI_M_ENDT_LETTER().setRendered(true);
			}else {
				getCOMP_UI_M_ENDT_LETTER().setRendered(false);
			}*/

				/*
				 * Commented by sankara narayanan for hospitalcash plan on 25/04/2017
				 * if("L".equalsIgnoreCase(PLAN_TYPE) )*/
				/*Changed  by sankara narayanan for hospitalcash plan on 25/04/2017*/
				if("L".equalsIgnoreCase(PLAN_TYPE) || "H".equalsIgnoreCase(PLAN_TYPE) )
					//END
				{
					...
					/*if(helper.enableDisablePremiumcalc(PT_IL_POLICY_BEAN)&& "N"
					.equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG())) */
					if(premCalc_Enable && "N"
							.equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG())) 
					{
				...
				/*	if("TRUE".equalsIgnoreCase(isprmcalc))
			{
				...
				if(!(("B08".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ADDL_STATUS()))||("N01".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ADDL_STATUS())))&& "1".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_DS_TYPE())){
					compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_APPROVAL().setDisabled(true);
				}
				
				/*Modified by Dhinesh on 16-10-2017 for Alteration button enable &disable*/
				if("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS())){
					if(!("D".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())||"S".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())||"M".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())) && "2".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_DS_TYPE())){
				...
				/*End*/
					...
					}else if("D".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())||"S".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())||"M".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_STATUS())){
						compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_ENDT().setRendered(true);
				...
				COMP_POL_ASSURED_NAME.setDisabled(true); //disable assured name always exception handled in 001 endo
				END_001changes();
				convertButtonEnable();
				disableButtons();
				...
				{
					/*sp_revival.upd_del_flag_rein_redate_agent(PT_IL_POLICY_BEAN.getPOL_SYS_ID());
				sp_revival.P_UPD_REDATE_ST_DATE(pt_il_policy_bean.getPOL_SYS_ID());
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getHelper().executeQuery(compositeAction);
				...
				/*Commentted by saritha on 20-06-2017 for ssp call id ZBILQC-1720514*/
				/*if ("S".equals(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE()) || "AD".equals(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE())) {
				COMP_POL_EMPLOYER_CODE.setDisabled(
						false);
			}else{
				COMP_POL_EMPLOYER_CODE.setDisabled(
						true);
			...
			else
			{
				...
				/*ADDED BY RAJA*/
				System.out.println("Assured flag value=========="+compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().isASSURED_FLAG());
				boolean assured_flag=compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().isASSURED_FLAG();
				if(assured_flag)
				{
					COMP_POL_ASSURED_NAME.setDisabled(false);
					System.out.println("assured code in onload========="+compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().getCONT_CODE());
					System.out.println("assured name in onload=========="+compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().getCONT_NAME());
					compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().setPOL_CONT_CODE(compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().getCONT_CODE());
					compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().setPOL_ASSURED_NAME(compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().getCONT_NAME());
				...
				/*END*/
				/*ADDED BY RAJA ON 10-07-2016. FOR SSP CALL ID - FALCONQC-1714559*/

				//System.out.println("CommonUtils.setGlobalVariable(GLOBAL.FLAGCUST, TRUE)  "+CommonUtils.getGlobalVariable("GLOBAL.FLAGCUST").toString());
				...
				/*if((PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS().equalsIgnoreCase("N")&&PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equalsIgnoreCase("Y")&&(
					PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("1")||PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("2")))||
					(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS().equalsIgnoreCase("A")&&PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equalsIgnoreCase("2")))
			{
				compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(false);

			}*/

				/*Added by Ramkumar on 06-08-2016 for QuotationNo field enable issue*/ 
				...
				/*Added by saritha on 20-Feb-2017 for RM018T - DEV_IL_ZB Life_027-Replacement Policy */
...
*/
				...
				/*Modified condition by saritha on 06-07-2017 for Endowment Product*/
				...
				/*Added by Ram on 12/04/2017 for disable FCPremium field disable process*/
				if(PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG() != null && PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG().equals("Y"))
				{
					getCOMP_POL_FC_MODAL_PREM().setDisabled(true);

					/*Added by Ram on 12/04/2017 for disable components after freezing policy*/
					getCOMP_POL_DISPATCH_DT().setDisabled(true);
					getCOMP_POL_DOC_ACK_DT().setDisabled(true);
					getCOMP_POL_DISPATCH_MTD().setDisabled(true);
					/*End*/

					/*Added by saranya on 24/04/2017 for disable Component after freezing policy*/
			...
			else
			{
				...
				if("D".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_UL_PREM_CALC()) && ("EDU".equals(getUnit_link_typ())))
				{
				...
				/*End*/
				System.out.println("SumAssured in onLoad        "+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FC_SUM_ASSURED());

				/*NEWLY ADDED BY DHINESH ON 12-06-2017*/
				if(!(CommonUtils.nvl(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_END_NO_IDX(),0)>0))
				{
				...
				/* Moved this code inside the isblockflag block by ganesh, 07-07-2017 ZBILQC-1719674*/
				/*Added By Ameen for Endorsements slip reports 12.9.2016*/

				System.out.println("END_CODE =="+PT_IL_POLICY_BEAN.getPOL_END_CODE()+" POL_STATUS"+PT_IL_POLICY_BEAN.getPOL_STATUS()+
						" FRZ_FLAG"+PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG());
				if(PT_IL_POLICY_BEAN.getPOL_END_CODE()!=null){
					END_FIELD_DISABLED(PT_IL_POLICY_BEAN.getPOL_STATUS(),PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG(),PT_IL_POLICY_BEAN.getPOL_END_CODE());
				...
				if(PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG()!=null && PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG().equalsIgnoreCase("Y"))
				{
					//Modified by ganesh on 24-08-2017, as suggested by Mr. Vikram and Siva to disable RI Allocation
					 if(PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equals("1") && PT_IL_POLICY_BEAN.getPOL_STATUS().equalsIgnoreCase("A") && PT_IL_POLICY_BEAN.getPOL_FAC_YN().equalsIgnoreCase("Y")){
						 compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(true);
					 }else{
						 compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(false);
					 }
				...
				ResultSet prodRS = new CRUDHandler().executeSelectStatement("SELECT PROD_CODE,PROD_POL_APPROVAL_YN FROM PM_IL_PRODUCT WHERE PROD_CODE = ?", 
								CommonUtils.getConnection(),new Object[]{PT_IL_POLICY_BEAN.getPOL_PROD_CODE()});
				if(prodRS.next()){
			...
			/*Commented and Moved this code inside the isblockflag block by ganesh, 07-07-2017 ZBILQC-1719674*/
			/*Added By Ameen for Endorsements slip reports 12.9.2016*/
			...
			if(!"A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS()) && CommonUtils.nvl(CommonUtils.getGlobalVariable("GLOBAL.FRZ_FLAG"),"N").equalsIgnoreCase("Y"))
			{
			...
			if("002".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_END_TYPE()))
			{
				if((compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_END_CODE().equalsIgnoreCase("INCSA") ||
...
/*Added by Ameen on 10-07-2017 for ZBILQC-1731204 as per siva sugg.*/
			...
			{ 
				...
				else if("L".equalsIgnoreCase(PLAN_TYPE))
				{
					if(PT_IL_POLICY_BEAN.getROWID()==null){
						...
						/* Modified by Dhinesh on 06-10-2017 suggested by Sivaram : sum assured value defaulted 1000 for funeral plan */
					...
					.getPT_IL_POLICY_BEAN().getPOL_END_CODE(),"XXXX"),"INCSA","DECSA"))					
			{
				...
				int MedCount=0;
				Object[] values  = new Object[] { compositeAction.getPT_IL_POLICY_ACTION_BEAN()
						.getPT_IL_POLICY_BEAN().getPOL_SYS_ID()};
				ResultSet rs13 = new CRUDHandler().executeSelectStatement(medicalExamQry, CommonUtils.getConnection(), values);
				if (rs13.next()) {
					MedCount = rs13.getInt("count") ; 	
				}

				if(MedCount!=0 || "Y".equalsIgnoreCase(CommonUtils.nvl(CommonUtils.getGlobalVariable("GLOBAL.POAD_HIV_TEST_YN").toString(), "N")) )
				{
					compositeAction.getWizard().enableWizardItem("PILT002_APAC_PT_IL_POL_MED_EXAM_DTL");
			...
			/*Added by Ameen on 07-09-2017 for ZBILQC-1720075 as per Chandramohan sugg.*/
			if(PT_IL_POLICY_BEAN.getPOL_END_TYPE() != null && "009".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_TYPE())){
				if("CANPOL".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_CODE())){
					...
					Calendar cal = Calendar.getInstance();
					 ...
					 System.out.println("POL_ISSUE_DT ::" + polIssueDt + " :: POL_END_DT ::" + PT_IL_POLICY_BEAN.getPOL_END_DT());
					 ...
					 long diff = (polIssueDt.getTime() - PT_IL_POLICY_BEAN.getPOL_END_DT().getTime())/(24 * 60 * 60 * 1000);
			...
			/*Added by Ameen on 19-09-2017 for list issues to disable M.E. block for funeral and no M.E. records*/
				...
				/*Commentted &Modified by saritha on 14-12-2017 for ssp call id : ZBLIFE-1461947*/
				...
				/*Commented by ganesh on 06-02-2018 as suggested by Raja sir to enable always*/
				/*if(PLAN_TYPE.equals("L") || PLAN_TYPE.equals("H") || PLAN_TYPE.equals("U")){
					
					String coverQry = "SELECT 'X' FROM PT_IL_POL_ADDL_COVER WHERE POAC_COVER_CODE = '203R' AND POAC_POL_SYS_ID = ?";
					ResultSet coverRS = null;
					coverRS = new CRUDHandler().executeSelectStatement(coverQry,CommonUtils.getConnection(), 					
											new Object[]{compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SYS_ID()});
					if(coverRS.next()){
						...
						this.getCOMP_MORE_INFO_4().setDisabled(true);
					}
				}else{
			...
			/*End*/
				...
				/*Added by Ameen on 30-05-2018 for KIC as per siva sugg. to enable print btn based on autoUW*/
				String autoUW = "N";
				ResultSet autoRS = new CRUDHandler()
				...
				if ("Y".equalsIgnoreCase(autoUW)) {
					if(PT_IL_POLICY_BEAN.getPOL_ADDL_STATUS() != null && CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_ADDL_STATUS(), "C01","C02","I00","005")){
						COMP_POL_PRINT.setDisabled(false);
						COMP_POL_PRINT1.setDisabled(false);
					}
				}
				...
				if(PT_IL_POLICY_BEAN.getPOL_DS_TYPE().equals("1")){
					ResultSet rs = new CRUDHandler().executeSelectStatement("SELECT PS_VALUE FROM PP_SYSTEM1 WHERE PS_TYPE = 'IL_RI_BUTTON'",CommonUtils.getConnection());
					if(rs.next()){
				...
				System.out.println("Tested Value-->"+fetchInstanceData("PM_CUSTOMER_QE","PILT002_APAC","CUST_TEL_AREA_CODE2",5));
				...
				if(!"Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()) && PT_IL_POLICY_BEAN.getPOL_END_CODE() == null){
					pol_period_disable();
				}
				/*End*/
				...
				/*Added by Ameen on 06-07-2018 for KIC to disable POL_FRZ_FLAG based on POL_FLEX_20 in endorsements*/
				if(!"A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS()) && !"Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FLEX_20())){
				...
				if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_STATUS().equalsIgnoreCase("L")){
					COMP_POL_FRZ_FLAG.setDisabled(false);
					COMP_SAVE_BUTTON.setDisabled(false);
					COMP_SAVE_COMMAND_LINK.setDisabled(false);
...
/*Added by Janani on 20.05.2017 for SSP id ZBILQC-1719696*/
	...
	private void checkPropOrPol() {
		if ("2".equalsIgnoreCase(CommonUtils.nvl(PT_IL_POLICY_BEAN
				.getPOL_DS_TYPE(), "1"))) {
			setEndorseIndxVisibleFlag(true);
		}
		
		/*Added by ganesh on 14-04-2017 for amendment functionality in proposal */
		else if ("1".equalsIgnoreCase(CommonUtils.nvl(PT_IL_POLICY_BEAN
				.getPOL_DS_TYPE(), "1"))) {
	...
	private void quickCustomerDefault() {
		//System.out.println("GLOBAL.CUSTCODE  =========== "+CommonUtils.getGlobalVariable("GLOBAL.CUSTCODE").toString());

		if (CommonUtils.getGlobalVariable("GLOBAL.REFID") != null) {

			System.out.println("GLOBAL.REFID  =========== "+CommonUtils.getGlobalVariable("GLOBAL.REFID").toString());

			this.PT_IL_POLICY_BEAN.setPOL_ASSRD_REF_ID1(
		...
		if (CommonUtils.getGlobalVariable("GLOBAL.CUSTCODE") != null) {
			...
			this.PT_IL_POLICY_BEAN.setPOL_CUST_CODE(CommonUtils.getGlobalVariable(
					"GLOBAL.CUSTCODE").toString());

			this.PT_IL_POLICY_BEAN.setPOL_CONT_CODE(
					CommonUtils.getGlobalVariable("GLOBAL.CUSTCODE"));
		}
		...
		// System.out.println("GLOBAL.CONT_CODE =========== "+CommonUtils.getGlobalVariable("GLOBAL.CONT_CODE").toString());
		...
		if (CommonUtils.getGlobalVariable("GLOBAL.CONT_CODE") != null)
		{
			...
			this.PT_IL_POLICY_BEAN.setPOL_CONT_CODE(
					CommonUtils.getGlobalVariable("GLOBAL.CONT_CODE"));
		}
	...
	public void defaultPremPayorCode(String REF_ID1){
		...
		try {
			rs = new CRUDHandler().executeSelectStatement(premPayorQry, CommonUtils.getConnection(),new Object[]{REF_ID1});
			if(rs.next()){
	...
	private void convertButtonEnable() throws Exception {
		try{
			...
			if ("N".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN
					.getPOL_CONVERT_YN(), "N"))){
				if ("1".equalsIgnoreCase(CommonUtils
						.getGlobalVariable("GLOBAL.M_PARAM_11"))) {// Proposal&Quotation
					compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_CONVERT()
					.setRendered(true);
				...
				} else if ("2".equalsIgnoreCase(CommonUtils
						.getGlobalVariable("GLOBAL.M_PARAM_11"))) {// Policy
					compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_CONVERT()
					.setRendered(false);
	...
	public void enableDisableForApproveCondition() {
		...
		if (("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS()) || "Y"
				.equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()))) {
			disableAllComponent(true);
		System.out.println("*1111*");
			...
			.IL_BLOCK_POL_DISABLED(compositeAction);
			...
			if ("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS())
				...
				COMP_POL_FRZ_FLAG.setDisabled(false);
				// compositeAction.getDUMMY_ACTION_BEAN().get, ().setDisabled(true);
				compositeAction.getDUMMY_ACTION_BEAN()
				.getCOMP_UI_M_BUT_CONVERT().setDisabled(true);
			}
		} else {
	...
	private void decideCaptionOfWizard() {
		...
		if ("1".equalsIgnoreCase(CommonUtils
				.getGlobalVariable("GLOBAL.M_PARAM_11")) || "1".equalsIgnoreCase(CommonUtils
						.getGlobalVariable("POL_DS_TYPE"))) {
			setWizardCaption("Proposal Entry");
			compositeAction.getWizard().setWizardLabel(
					"PILT002_APAC_PT_IL_POLICY", "Proposal Entry");
			compositeAction.getComp().setTitle("Proposal Information");
			/*
			 * commentted by Ameen for KIC to make from respective properties file
			 * getCOMP_POL_NO_LABEL().setValue("Proposal No.");*/
			getCOMP_POL_NO_LABEL().setValue(Messages.getString(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")+"messageProperties_PILT002_APAC","PILT002_APAC$PT_IL_POLICY$UI_M_COPY_POL_NO_2$caption"));
			compositeAction.getDUMMY_ACTION_BEAN()
			.getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(true);
						CommonUtils
			.setGlobalVariable("POL_DS_TYPE",null);
		} else if ("2".equalsIgnoreCase(CommonUtils
				.getGlobalVariable("GLOBAL.M_PARAM_11")) || "2".equalsIgnoreCase(CommonUtils
				.getGlobalVariable("POL_DS_TYPE"))) {
			setWizardCaption("Policy Entry");
			compositeAction.getWizard().setWizardLabel(
					"PILT002_APAC_PT_IL_POLICY", "Policy Entry");
			compositeAction.getComp().setTitle("Policy Information");
			/*
			 * commentted by Ameen for KIC to make from respective properties file
			 * getCOMP_POL_NO_LABEL().setValue("Policy No.");*/
			getCOMP_POL_NO_LABEL().setValue( Messages.getString(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")+"messageProperties_PILT002_APAC","PILT002_APAC$PT_IL_POLICY$POL_NO$Caption"));
			if (!("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS()))) {
				//compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_PREM_ALLOC().setDisabled(true);
			} else {
				compositeAction.getDUMMY_ACTION_BEAN()
	...
	public String backButton() {
		...
		if(!"".equals(todmsworkflow)&&todmsworkflow!=null)
		{
			...
			CommonUtils.setGlobalVariable("backValue", "");
				...
				|| "PILP001_APAC".equals(callingForm)
				|| "PILT010".equals(callingForm)) {
			outcome = "PILT002_APAC";
		} else if(null != callingForm && !(callingForm.trim().isEmpty()) && "PILT006_APAC".equals(CommonUtils.getGlobalVariable("CLAIM_CALLING_FORM"))) {
			CommonUtils.setGlobalVariable("CLAIM_CALLING_FORM","PILT002_APAC");
			outcome = "claimsEntry";
		} 
		
		else if(CommonUtils.getGlobalVariable("GLOBAL.QUERY_BACK")!=null && CommonUtils.getGlobalVariable("GLOBAL.QUERY_BACK").equalsIgnoreCase("TRUE"))
		{
			outcome="PILQ002-I01";
	...
	public String approveButtonAction() {
		...
		try {
			/*added by gopi for toi on 14/06/2018*/
			 ...
			 if(pol_frz_flag!=null && "Y".equalsIgnoreCase(pol_frz_flag)){
			 if(policy_aaprove!=null && "O".equalsIgnoreCase(policy_aaprove)){
				 System.out.println("PILPK_POLICY_APPROVAL().P_POLICY_DIRECT_APPROVAL PROCEDURE EXECUTED SUCCESSFULLY");
			...
			String emailStatusMessage = Email_Procedure_Call.emailStatusMsg(PT_IL_POLICY_BEAN.getPOL_PROD_CODE(),
					"POL",policyNumber.toString(), "C", "");
			//end
...
*/
	...
	public String endorsementButtonAction() {
		...
		try {
			...
			/*Added by Ram on 07/04/2017*/
			getProd_plan_type();
			/*Modified if condition by ganesh on 06-07-2017, as suggested by ajoy*/
			/*if("L".equalsIgnoreCase(PLAN_TYPE))*/
			...
			endorsementScreenId = dummy_helper
					.UI_M_BUT_ENDT_WHEN_BUTTON_PRESSED(compositeAction);
			
			/* Added by ganesh on 03-04-2017,to avoid CBC validation issue when come back to policy screen from endorsement*/
			setBlockFlag(true);
			/*end*/
	...
	public String endorsementOKButtonAction() {
		...
		try {
			...
			if("006".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_TYPE())){
				new P9ILPK_PROCESS().P_REIN_TILL_DT(PT_IL_POLICY_BEAN.getPOL_SYS_ID().toString(), CommonUtils.dateToStringFormatter(new Date())); 
				
			}			
			/*end*/
			helper.POL_END_EFF_FROM_DT_WHEN_VALIDATE_ITEM(compositeAction,
			...
			/*Added by Ameen on 18/11/2016 for Endorsement Cancellation Procedure*/
			new P9ILPK_ENDORSE().P_VALIDATE_PROCAN(PT_IL_POLICY_BEAN
					.getPOL_SYS_ID());
			/*End*/
			}
			...
			if(planObj!=null && planObj.getPLAN_TYPE().equalsIgnoreCase("U")){
				if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_END_CODE().equalsIgnoreCase("GEN016")){
	...
	public void updatePOL_END_EFF_FROM_DT(PILT002_APAC_COMPOSITE_ACTION compositeAction) throws Exception{
		...
		//String query = "UPDATE PT_IL_POLICY SET POL_END_EFF_FROM_DT='"+datevaluefrom+"',POL_END_EFF_TO_DT='"+datevalueto+"'WHERE POL_SYS_ID= ? ";
		/*String query = "UPDATE PT_IL_POLICY SET POL_END_EFF_FROM_DT='"+datevaluefrom+"',POL_END_EFF_TO_DT='"+datevalueto+"'WHERE POL_SYS_ID='"+pol_sys_is+"'";*/
		String query = "UPDATE PT_IL_POLICY SET POL_END_EFF_FROM_DT=?,POL_END_EFF_TO_DT=? WHERE POL_SYS_ID=?";


		System.out.println("query executed "+query);

		new CRUDHandler().executeUpdateStatement(query, connection,new Object[] {datevaluefrom,datevalueto,pol_sys_is});
		////new CRUDHandler().executeUpdateStatement(query, connection,pol_sys_is);
		connection.commit();
	}
	...
	private void doc_gen_noButton_Action() {
		...
		try {
			...
			/*Added if condition by R. Raja for policy no generation issue on 17-12-2016*/
			
			if (PT_IL_POLICY_BEAN.getPOL_NO() == null) {
				
				/*end*/
			dummy_helper.UI_M_BUT_DOC_GEN_NO_WHEN_BUTTON_PRESSED(
					PT_IL_POLICY_BEAN, compositeAction.getDUMMY_ACTION_BEAN()
		...
		try
{
		...
		/*compositeAction added by saritha on 04-08-2017 for freeze flag yes choose then save  error: freeze flag null */  
...
/*End*/
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_PREM_OPTION(
			Object currValue) {
		...
		try {
			suggestionList = listitemutil.P_CALL_LOV("PILT002_APAC",
					"PT_IL_POLICY", "POL_PREM_OPT", "IL_PREM_OPT", null, null, null,
					null, (String) currValue);
			System.out.println("suggestionList     "+suggestionList);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_STAFF_CCLASS_CODE(
		...
		try {
			...
			suggestionList = listitemutil.P_CALL_LOV("PILT002_APAC",
					"PT_IL_POLICY", "POL_STAFF_CCLASS_CODE", "002", null, null,
					null, null, (String) currValue);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public ArrayList<LovBean> lovUI_M_POL_CONT_AD_ACC_NO(Object object) {
		...
		try {
			...
			if ("Y".equals(M_CREDIT_CARD_UPD_YN)) {
				suggestionList = ListItemUtil.prepareSuggestionList(lovQuery,
						new Object[] { PT_IL_POLICY_BEAN.getPOL_CUST_CODE(),
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_RI_POOL_CODE(Object currValue) {
		...
		try {
			...
			suggestionList = listitemutil.P_CALL_LOV("PILT002_APAC",
					"PT_IL_POLICY", "POL_RI_POOL_CODE", null, null, null, null,
					null, (String) currValue);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_STATE_CODE(
			Object currValue) {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_COUNT_CODE(
			Object currValue) {
	...
	public List<com.iii.premia.common.bean.LovBean> lovPOL_OFF_AREA_CODE(
			Object currValue) {
	...
	public List<com.iii.premia.common.bean.LovBean> lovPOL_END_CODE(
			Object currValue) {
		...
		try {
			/*
			 * Commented by sankaraNarayanan for lovendsement ref by Sivaraman sir on 23-10-2016
			 * 
			 * 
			 * 
			 * 
		 ...
		 * }else{
				...
				bean.setCode("END001");
				bean.setName("Non-Financial Endorsement");
				LovBean bean1 = new LovBean();
				bean1.setCode("CANPOL");
				bean1.setName("Cancellation policy");
	...
	public ArrayList<LovBean> lovPOL_EMPLOYER_CODE(Object object) {
		...
		/*
		 * condition modified by Ameen on 25-03-2018 for KIC to add crdit card & Knet option
		 * if((PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AD"))||(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("BS")))*/
		if((PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AD"))||(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("BS")) ||
				(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("SC"))||(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("B")))
		{
		/*End*/
			
			/*changed by raja on 16-05-2017*/
		/*query = "SELECT CUST_CODE,CUST_NAME FROM PM_CUSTOMER,PM_CUST_CLASS "
			...
			//query = "SELECT BANK_CODE,BANK_NAME FROM FM_BANK WHERE ROWNUM < ?  ORDER BY 1 ASC";
		...
		/*else if(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("S") ||  PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("BS") )*/
		
		/*Modified by Janani on 27.06.2018 for FLA as per Chandramohan sugges*/
		//else if(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("S"))
		
		else if(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("S") || PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE().equalsIgnoreCase("AO")) 
		...
		{ //end
			/*Modified by ganesh on 16-06-2017,ZBILQC-1719874 as per the girsh suggestion*/
			/*query = "SELECT CUST_CODE,CUST_NAME FROM PM_CUSTOMER,PM_CUST_CLASS "
			...
			/*query = "SELECT CONT_NAME,CONT_CODE, CONT_EMPLOYER_YN FROM PM_IL_CONTRACTOR WHERE CONT_EMPLOYER_YN = 'Y'"
					+ "AND (UPPER(CUST_CODE) LIKE ? OR UPPER(CUST_NAME) LIKE ?) AND ROWNUM < ?";*/
			
		/*
		 * commented By Dhinesh 3-10-2017 
		 * 
		 * 	query = "SELECT CONT_CODE,CONT_NAME, CONT_EMPLOYER_YN FROM PM_IL_CONTRACTOR WHERE CONT_EMPLOYER_YN = 'Y'"
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_PLAN_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_SRC_OF_BUS(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_SUB_PLAN_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_ADDL_STATUS(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_PROJECT_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_CLASS_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<LovBean> lovPOL_ASSRD_REF_ID2(Object currValue) {
		...
		try {
			...
			if(Benef_cust_flag!=null && "Y".equalsIgnoreCase(Benef_cust_flag)){
				...
				if ("*".equals(code)) {
					object = new Object[] { PELConstants.suggetionRecordSize,cust_code,PT_IL_POLICY_BEAN.getPOL_PROD_CODE()};
					query = PT_IL_POLICY_QUERY_CONSTANTS.POL_ASSRD_REF_ID2_QUERY;
				} else {
					object = new Object[] { code + "%", code + "%",
							PELConstants.suggetionRecordSize,cust_code,PT_IL_POLICY_BEAN.getPOL_PROD_CODE() };
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_SA_CURR_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_DEPT_CODE(
			Object currValue) {
		ArrayList<com.iii.premia.common.bean.LovBean> suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
		ListItemUtil listitemutil = new ListItemUtil();
		try {
	...
	/*
	 * public ArrayList<LovBean> lovPOL_CUST_CODE(Object currValue) { ArrayList<com.iii.premia.common.bean.LovBean>
	 * suggestionList = new ArrayList<com.iii.premia.common.bean.LovBean>();
	 * ListItemUtil listitemutil = new ListItemUtil(); String M_FACIN_YN = null;
	 ...
	 * else { if ("N".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN
	 * .getPOL_CASH_YN(), "N"))) { if ("N".equals(CommonUtils.nvl(M_FACIN_YN,
	 * "N"))) {
	 * 
	 * suggestionList = listitemutil.P_CALL_LOV( "PILT002_APAC", "PT_IL_POLICY",
	 ...
	 * else { suggestionList = listitemutil.P_CALL_LOV( "PILT002_APAC",
	 * "PT_IL_POLICY", "POL_CUST_CODE", "REINS", PT_IL_POLICY_BEAN
	 * .getPOL_DIVN_CODE(), "REINS", null, null, (String) currValue); //
	 * STD_CALL_LOV('PILH152','PT_IL_POLICY.POL_CUST_CODE','REINS',:PT_IL_POLICY.POL_DIVN_CODE,'REINS'); } }
	 * else { suggestionList = listitemutil.P_CALL_LOV("PILT002_APAC",
	 * "PT_IL_POLICY", "POL_CUST_CODE", "CASH",
	 * PT_IL_POLICY_BEAN.getPOL_DIVN_CODE(), "CASH", null, null, (String)
	 * currValue); //
	 * STD_CALL_LOV('PILH152','PT_IL_POLICY.POL_CUST_CODE','CASH',:PT_IL_POLICY.POL_DIVN_CODE,'CASH'); } } }
	 * catch (Exception e) { e.printStackTrace(); } return suggestionList; }
	 */
	...
	public void validatePOL_WAQAF_PERIOD_TO(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_WAQAF_PERIOD_TO_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_WAQAF_PERIOD_FM(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_WAQAF_PERIOD_FM_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_DEF_PERIOD_TO(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_DEF_PERIOD_TO_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_DEF_PERIOD_FM(FacesContext facesContext,
		...
		try {
			...
			helper.POL_DEF_PERIOD_FM_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_BASIC_RATE1(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_BASIC_RATE1_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_CLASS_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_CLASS_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_DEPT_CODE(FacesContext facesContext,
		...
		try {
			...
			helper.POL_DEPT_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_DIVN_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_DIVN_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_LC_PRE_TPD_BNF(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_LC_PRE_TPD_BNF_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_FC_PRE_TPD_BNF(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_PRE_TPD_BNF_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_LC_CLIENT_ALLOC_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_LC_CLIENT_ALLOC_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_FC_CLIENT_ALLOC_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_CLIENT_ALLOC_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_LC_BANK_ALLOC_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_LC_BANK_ALLOC_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_FC_BANK_ALLOC_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_BANK_ALLOC_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_LC_NET_PREM(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_LC_NET_PREM_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_FC_NET_PREM(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_NET_PREM_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_END_EFF_TO_DT(FacesContext facesContext,
		...
		try {
			helper.POL_END_EFF_TO_DT_WHEN_VALIDATE_ITEM(compositeAction,
					curDate);
	...
	public void validatePOL_END_NO(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_END_NO_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_TARIFF_TERM_FLAG(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void validatePOL_END_DT(FacesContext facesContext,
		...
		try {
			...
			helper.P_VALIDATE_END_EFF_DT(String.valueOf(POL_SYS_ID), 
					CommonUtils.dateToStringFormatter(POL_END_DT),POL_END_TYPE);
			//end
	...
	public void validatePOL_END_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException, DBException {
		CommonUtils.clearMaps(this);
		...
		try {
			helper.POL_END_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
			PT_IL_POLICY_BEAN.setPOL_END_CODE((String) value);
			System.out.println("Endorsement Code::::"+PT_IL_POLICY_BEAN.getPOL_END_CODE());

			/*
			 * As per the requirement by vinoth, except General endorsement other endorsement should send the 
			 * endorsement date not effective date
			 * 
			 * ssp call id FALCONQC-1714633 added by ganesh
			 */

			System.out.println("Endorsement type ["+(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_TYPE(), "000")+"]"));
			...
			/*Added by ganesh on 03-04-2017, need to default endorsement eff. from date 
			 * to nextanniversaryrenewal date only for MOP endorsment other than inception date should default
			 * sugested by Mr.Ajoy*/
			System.out.println("endFromDateSysParam-->"+endFromDateSysParam);
			
			
			//Modified by ganesh on 13-04-2017 set effective from date at first time only not all time.*/
			/*if(endFromDateSysParam.intValue() == 2){*/
			/*
			 * commented by Ameen on 21-06-2017 as per ZB requirement except POL_EN_TYPE = 001 every endorsement want to set next unpaid prem. collection date : ZBILQC-1719974
			 * if(endFromDateSysParam.intValue() == 2 && PT_IL_POLICY_BEAN.getPOL_END_EFF_FROM_DT()==null){
			...
			/*if(!CommonUtils.isIN(endorseType,"001","009","006"))*/
				...
				/*else if(PT_IL_POLICY_BEAN.getPOL_END_CODE().equalsIgnoreCase("DMWP"))*/
			 ...
			 *  
			 */
			/*	if((CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_END_TYPE(), "000").equalsIgnoreCase("002"))){
				//COMP_UI_M_BUT_ENDT_OK.setDisabled(true);
				throw new Exception("Premium due exists - Cannot proceed with Financial Endorsement");
			...
			//end
			/*
			 * Commented by Ameen on 28-03-2017 as per Ajoy suggestion to set value in onload and disable the field
			 * PT_IL_POLICY_BEAN.setPOL_END_EFF_TO_DT(PT_IL_POLICY_BEAN.getPOL_EXPIRY_DT());*/
			System.out.println(PT_IL_POLICY_BEAN.getPOL_START_DT()+","+PT_IL_POLICY_BEAN.getPOL_END_EFF_FROM_DT()+","+PT_IL_POLICY_BEAN.getPOL_EXPIRY_DT());
			...
			/*if(PT_IL_POLICY_BEAN.getPOL_END_TYPE().equalsIgnoreCase("012")){
				if (PT_IL_POLICY_BEAN.getPOL_END_EFF_FROM_DT() == null) {
					PT_IL_POLICY_BEAN.setPOL_END_EFF_FROM_DT(PT_IL_POLICY_BEAN.getPOL_START_DT());
					COMP_POL_END_EFF_FROM_DT.setDisabled(true);

				}
			}else{
				COMP_POL_END_EFF_FROM_DT.setDisabled(false);
			}
			...
			//END
			if("020".equalsIgnoreCase(CommonUtils.nvl(
			...
			/*Date sysdate = new Date();
			String sysdateString = CommonUtils.dateToStringFormat(sysdate);
			PT_IL_POLICY_BEAN.setPOL_END_DT(CommonUtils.stringToDate(sysdateString, "dd/MM/yyyy"));*/
			COMP_POL_END_DT.resetValue();
			...
			if(PT_IL_POLICY_BEAN.getPOL_END_CODE().equalsIgnoreCase(this.getChkEndCode()) && 
					((compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN().getPOAD_FAMILY_YN() != null &&
					compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN().getPOAD_OCC_YN() != null) &&
					(compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN().getPOAD_FAMILY_YN().equalsIgnoreCase("N") &&
							compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN().getPOAD_OCC_YN().equalsIgnoreCase("n"))))
	...
	public void validatePOL_HEALTH_RATE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_HEALTH_RATE_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_FC_BASIC_PREM(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_BASIC_PREM_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_BASIC_RATE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_BASIC_RATE_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_OFF_AREA_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_OFF_AREA_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_STATE_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_STATE_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_CITY_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_CITY_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_RES_AREA_CODE(FacesContext facesContext,
		...
		try {
			...
			helper.POL_RES_AREA_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_FRZ_FLAG(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FRZ_FLAG_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
...
*/
				...
				/*
				 * commented by dhinesh on 12-06-2017 for canpol endorsement error message validation 
				 * 
				...
				/*Newly added by Dhinesh on 12-06-2017 for canpol endorsement error message validation*/
			...
			/*
			 * 
			 * Commented by sankara narayanan for frz flag is handled by ui component on 21-03-2017
			 * 
			...
			//end			
			 ...
			 else
			 {
				...
				/* Newly Added By Dhinesh on 11.8.2017 for ssp call id : ZBILQC-1733134 */ 
				 /*
				  * commentd by Ameen on 19-04-2018 for KIC to place it in ajaz event
				  * PT_IL_POLICY_BEAN.setPOL_FLEX_20(null);*/
				/* End */
			 }
			 /*END*/
	...
	public void validatePOL_PROP_REF_NO(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_PROP_REF_NO_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_FC_EXC_INT_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_EXC_INT_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_LC_EXC_INT_AMT(FacesContext facesContext,
		...
		try {
			cuDouble = helper.POL_LC_EXC_INT_AMT_WHEN_VALIDATE_ITEM(
					compositeAction, cuDouble);
	...
	public void validatePOL_PROP_DECL_DT(FacesContext facesContext,
		...
		try {
			helper
			.POL_PROP_DECL_DT_WHEN_VALIDATE_ITEM(compositeAction,
					curDate);
	...
	public void validatePOL_PROP_STAMP_DT(FacesContext facesContext,
		...
		try {
			...
			helper.POL_PROP_STAMP_DT_WHEN_VALIDATE_ITEM(compositeAction,
					curDate);
	...
	public void validatePOL_PROP_RECV_DT(FacesContext facesContext,
		...
		try {
			...
			helper
			.POL_PROP_RECV_DT_WHEN_VALIDATE_ITEM(compositeAction,
					curDate);
	...
	public void validatePOL_PROJECT_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_PROJECT_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_PROFIT_RATE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_PROFIT_RATE_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_AUTH_LIMIT(FacesContext facesContext,
		...
		try {
			...
			helper.POL_AUTH_LIMIT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_CARD_HOLDER_NAME(FacesContext facesContext,
		...
		try {
			...
			helper.POL_CARD_HOLDER_NAME_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_CONT_AD_BANK_CODE(FacesContext facesContext,
		...
		try {
			...
			helper.POL_CONT_AD_BANK_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateUI_M_POL_CONT_AD_ACC_NO(FacesContext facesContext,
		...
		try {
			...
			helper.UI_M_POL_CONT_AD_ACC_NO_WHEN_VALIDATE_ITEM(compositeAction,
					(Long) value);
	...
	public void validatePOL_CQS_PERC(FacesContext facesContext,
		...
		try {
			...
			helper.POL_CQS_PERC_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validateListChangedPOL_CQS_YN(ActionEvent actionEvent)
		...
		try {
			helper
			.POL_CQS_YN_WHEN_LIST_CHANGED(compositeAction,
					(String) value);
	...
	public void validatePOL_CQS_YN(FacesContext facesContext,
		...
		try {
			PT_IL_POLICY_BEAN.setPOL_CQS_YN((String) value);
			helper.POL_CQS_YN_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_FAC_BASIS(FacesContext facesContext,
		...
		try {
			...
			helper.POL_FAC_BASIS_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateListChangedPOL_FAC_YN(ActionEvent actionEvent)
		...
		try {
			helper
			.POL_FAC_YN_WHEN_LIST_CHANGED(compositeAction,
					(String) value);
	...
	public void validatePOL_FAC_YN(FacesContext facesContext,
		...
		try {
			PT_IL_POLICY_BEAN.setPOL_FAC_YN((String) value);
			helper.POL_FAC_YN_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
			COMP_POL_FAC_BASIS.resetValue();
			COMP_POL_RI_POOL_CODE.resetValue();
	...
	public void validatePOL_STAFF_CCLASS_CODE(FacesContext facesContext,
		...
		try {
			...
			helper.POL_STAFF_CCLASS_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateListChangedPOL_STAFF_YN(ActionEvent actionEvent)
		...
		Object value = uiInput.getSubmittedValue();
		try {
			helper.POL_STAFF_YN_WHEN_LIST_CHANGED(compositeAction,
					(String) value);
	...
	public void validatePOL_STAFF_YN(FacesContext facesContext,
		...
		try {
			...
			helper.POL_STAFF_YN_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_INTRODUCER_REF_ID1(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_INTRODUCER_REF_ID1_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_BANK_BRANCH_NAME(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_BANK_BRANCH_NAME_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateListChangedPOL_GRANTEE_TYPE(ActionEvent actionEvent)
		...
		Object value = uiInput.getSubmittedValue();
		try {
			helper.POL_GRANTEE_TYPE_WHEN_LIST_CHANGED(compositeAction,
					(String) value);
	...
	public void validatePOL_GRANTEE_TYPE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_GRANTEE_TYPE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateListChangedPOL_INCORPORATED_YN(ActionEvent actionEvent)
		...
		Object value = uiInput.getSubmittedValue();
		try {
			helper.POL_INCORPORATED_YN_WHEN_LIST_CHANGED(compositeAction,
					(String) value);
	...
	public void validatePOL_INCORPORATED_YN(FacesContext facesContext,
		...
		try {
			PT_IL_POLICY_BEAN.setPOL_INCORPORATED_YN((String) value);
			helper.POL_INCORPORATED_YN_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
			COMP_POL_FC_BANK_ALLOC_AMT.resetValue();
			COMP_POL_LC_BANK_ALLOC_AMT.resetValue();
			COMP_POL_FC_CLIENT_ALLOC_AMT.resetValue();
	...
	public void validatePOL_DEFER_PRD(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_DEFER_PRD_WHEN_VALIDATE_ITEM(PT_IL_POLICY_BEAN,
					(Double) value);
	...
	public void validatePOL_EMPLOYER_CODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_EMPLOYER_CODE_WHEN_VALIDATE_ITEM(PT_IL_POLICY_BEAN,
					(String) value);
	...
	public void validatePOL_PAYOR_SDCODE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_PAYOR_SDCODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validateListChangedPOL_PYMT_TYPE(ActionEvent actionEvent)
		...
		Object value = uiInput.getSubmittedValue();
		try {
			helper.POL_PYMT_TYPE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
	...
	public void validatePOL_FC_MON_ANNU_AMT(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_MON_ANNU_AMT_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_LAST_INST_DT(FacesContext facesContext,
		...
		try {
			...
			helper.POL_LAST_INST_DT_WHEN_VALIDATE_ITEM(PT_IL_POLICY_BEAN
					.getPOL_FIRST_INST_DT(), POL_LAST_INST_DT);
	...
	public void validatePOL_LC_DEPOSIT_AMOUNT(FacesContext facesContext,
		...
		try {
			helper.POL_LC_DEPOSIT_AMOUNT_WHEN_VALIDATE_ITEM(compositeAction,
					currDouble);
	...
	public void validatePOL_FC_DEPOSIT_AMOUNT(FacesContext facesContext,
		...
		Double currDouble = (Double) value;
		try {
			currDouble = helper.POL_FC_DEPOSIT_AMOUNT_WHEN_VALIDATE_ITEM(
					compositeAction, currDouble);
	...
	public void validatePOL_LC_SUM_ASSURED(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_LC_SUM_ASSURED_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validateClearBlockPOL_FC_SUM_ASSURED(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_SUM_ASSURED_WHEN_CLEAR_BLOCK(compositeAction,
					(Double) value);
	...
	public void validateNewItemInstancePOL_FC_SUM_ASSURED(
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_FC_SUM_ASSURED_WHEN_NEW_ITEM_INSTANCE(compositeAction,
					(Double) value);
			PT_IL_POLICY_BEAN.setPOL_FC_SUM_ASSURED((Double) value);
			// COMP_POL_FC_SUM_ASSURED.resetValue();
		} catch (Exception exception) {
	...
	public void validatePOL_FC_SUM_ASSURED(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			//helper.thresholdLimitAdding(PT_IL_POLICY_BEAN, compositeAction, (Double) value);
			...
			if(PT_IL_POLICY_BEAN.getPOL_END_NO_IDX() != null && PT_IL_POLICY_BEAN.getPOL_END_NO_IDX() > 0 
					&& PT_IL_POLICY_BEAN.getPOL_END_TYPE() != null && !"001".equals(PT_IL_POLICY_BEAN.getPOL_END_TYPE())){
			...
			System.out.println("PT_IL_POLICY_BEAN.getPOL_PREM_PAY_YRS() =======>>>>>>"+PT_IL_POLICY_BEAN.getPOL_PREM_PAY_YRS());
	...
	public void validatePOL_MODE_OF_PYMT_RATE(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_MODE_OF_PYMT_RATE_WHEN_VALIDATE_ITEM(compositeAction,
					(Double) value);
	...
	public void validatePOL_NO_OF_INST(FacesContext facesContext,
		...
		CommonUtils.clearMaps(this);
		try {
			helper.POL_NO_OF_INST_WHEN_VALIDATE_ITEM(compositeAction,
					(Integer) value);
	 ...
	 * "POL_MODE_OF_PYMT", getWarningMap()); } catch (Exception e) {
	 * e.printStackTrace(); } } }
	 * 
	 */public void validatePOL_MODE_OF_PYMT(FacesContext facesContext,
		 ...
		 try {
			 ...
			 helper.POL_MODE_OF_PYMT_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
	 ...
	 public void validatePOL_LC_MODAL_PREM(FacesContext facesContext,
		 ...
		 try {
			 currDouble = helper.POL_LC_MODAL_PREM_WHEN_VALIDATE_ITEM(
					 compositeAction, currDouble);
	 ...
	 public void validatePOL_NO_OF_UNIT(FacesContext facesContext,
		 ...
		 try {
			 ...
			 helper.POL_NO_OF_UNIT_WHEN_VALIDATE_ITEM(compositeAction,
					 (Double) value);
	 ...
	 public void validatePOL_FC_MODAL_PREM(FacesContext facesContext,
		 ...
		 try {
			 currValue = helper.POL_FC_MODAL_PREM_WHEN_VALIDATE_ITEM(
					 compositeAction, currValue);
	 ...
	 public void validatePOL_CUST_CURR_CODE(FacesContext facesContext,
		 ...
		 CommonUtils.clearMaps(this);
		 try {
			 helper.POL_CUST_CURR_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
	 ...
	 public void validatePOL_SA_EXCH_RATE(FacesContext facesContext,
		 ...
		 try {
			 ...
			 currvalue = helper.POL_SA_EXCH_RATE_WHEN_VALIDATE_ITEM(
					 compositeAction, currvalue);
	 ...
	 public void validatePOL_SA_CURR_CODE(FacesContext facesContext,
		 ...
		 try {
			 ...
			 helper.POL_SA_CURR_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
			 COMP_POL_SA_EXCH_RATE.resetValue();
	 ...
	 public void validatePOL_EXPIRY_DT(FacesContext facesContext,
		 ...
		 try {
			...
			if("O".equalsIgnoreCase(P_PROD_POL_APPROVAL_YN)){
			 ...
			 helper.POL_EXPIRY_DT_WHEN_VALIDATE_ITEM(PT_IL_POLICY_BEAN,
					 cal.getTime());
	 ...
	 public void validatePOL_START_DT(FacesContext facesContext,
		 ...
		 try {
			 ...
			 /*Commented and added by saranya for ssp call ZBILQC-1718566 on 20-01-2016*/
			 PT_IL_POLICY_BEAN.setPOL_START_DT(currValue);
			 ...
			 if("1".equalsIgnoreCase(Value)){
				 if(!("01".equals(M_POL_ST_DT)))
				 {
					...
					// compositeAction.getPT_IL_POLICY_ACTION_BEAN().getErrorMap().put("current", "Start Date Should be Month Start Date");
				 }
			 }
			 /*End*/
			 ...
			 helper.
			 POL_START_DT_WHEN_VALIDATE_ITEM(compositeAction, currValue);
			 COMP_POL_EXPIRY_DT.resetValue();
			 COMP_POL_FIRST_INST_DT.resetValue();
			 COMP_POL_UW_YEAR.resetValue();
			 COMP_POL_START_DT.resetValue();
			 /*Newly added by pidugu raj for pol period update if start date changes as suggested by sivaraman dt: 29-11-2018*/
	 ...
	 public void validatePOL_PREM_PAY_YRS(FacesContext facesContext,
		 ...
		 try {
			 ...
			 if(!(values.equals(beanValue))){
				 ...
				 values = helper.POL_PREM_PAY_YRS_WHEN_VALIDATE_ITEM(
						 compositeAction, values);
	 ...
	 public void validatePOL_PERIOD(FacesContext facesContext,
		 ...
		 try {
			 ...
			 /*Newly added by pidugu raj dt: 15-09-2020 as suggested by kuzhandaivel for Alliance IL*/
			/* if(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_PROD_CODE().equalsIgnoreCase("EDU00001")){
			 String term =String.valueOf(value);
			 if(!((term).equals("10") || (term).equals("12") || (term).equals("15"))){
				 throw new Exception("Please choose term value as either 10 or 12 or 15");
			 }
			 }*/
			 /*End newly added by pidugu raj dt: 15-09-2020 as suggested by kuzhandaivel for Alliance IL*/
			 //PT_IL_POLICY_BEAN.setPOL_PERIOD((Integer) value);
			 int  prev=CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_PERIOD(),0);
			 System.out.println("PT_IL_POLICY_BEAN.getPOL_PERIOD()  :"+prev);
			 /*Added by Ameen on 27-07-2018 for KIC To change pol_period KICLIFEQC-1759635 - 2,6*/
			...
			/*End*/
			 PT_IL_POLICY_BEAN.setPOL_PERIOD((Integer) value);
			 /*Added by Ram on 29/11/2016 for Defaulting Premium Paying years value while tabbing out from Period in Years field*/
			 
			 /*Commentted &Modified by saritha on 07-09-2017 for ssp call id ZBILQC-1736358 as suggestted by siva sir*/
			 /*if(!"S".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_MODE_OF_PYMT()))
			 {
			...
			System.out.println("111 PT_IL_POLICY_BEAN.getPOL_MODE_OF_PYMT()  : "+PT_IL_POLICY_BEAN.getPOL_MODE_OF_PYMT());
			 ...
			 if(!"S".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_MODE_OF_PYMT()))
			 {
				 System.out.println("Enter the Mode of payment if block **** "+ PT_IL_POLICY_BEAN.getPOL_PREM_PAY_YRS());
				...
				/*else
				 {
					 PT_IL_POLICY_BEAN.setPOL_PREM_PAY_YRS(PT_IL_POLICY_BEAN.getPOL_PERIOD()); 
				 }*/
				 /*End*/
				 
				System.out.println(" PT_IL_POLICY_BEAN.setPOL_PREM_PAY_YRS    "+ PT_IL_POLICY_BEAN.getPOL_PREM_PAY_YRS());
				 COMP_POL_PREM_PAY_YRS.resetValue();
	  ...
	  * public void validatePOL_SUB_PLAN_CODE(FacesContext facesContext,
		 ...
		 CommonUtils.clearMaps(this);
		 try {
			 helper.POL_SUB_PLAN_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
	 ...
	 public void validatePOL_SUB_PLAN_CODE(FacesContext facesContext,
		 ...
		 try {
			 ...
			 List<OracleParameter> subPlanSARangeList = helper.callP_FUNERAL_SUB_PLAN_DFLT_SA(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_PROD_CODE(),
					 compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_SUB_PLAN_CODE());

			 if(subPlanSARangeList != null){
				 
				 if(subPlanSARangeList.get(0).getValueObject() != null && subPlanSARangeList.get(1).getValueObject() != null)
				 {
				 ...
				 CommonUtils.setGlobalVariable("GLOBAL.SUB_PLAN_SA_Min", subPlanSARangeList.get(0).getValueObject().toString());
				 CommonUtils.setGlobalVariable("GLOBAL.SUB_PLAN_SA_MAX", subPlanSARangeList.get(1).getValueObject().toString());
	 ...
	 public void validatePOL_CONT_CODE(FacesContext facesContext,
		 ...
		 try {
			...
			connection=CommonUtils.getConnection();
			ResultSet resultSet1=null;
			/*resultSet1=new CRUDHandler().executeSelectStatement(query, connection, new Object[]{value});
			while(resultSet1.next())
			{
				REF1=resultSet1.getString("CONT_REF_ID1");
			}
			
			if(REF1!=null && !REF1.equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1()))
			{
				throw new Exception("");
			}*/
			 ...
			 if(!(PT_IL_POLICY_BEAN.getPOL_CONT_CODE().equals(null)))
			 {
				 ...
				 if(compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().isASSURED_FLAG())
				 {
					 compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setASSURED_FLAG(false);
				 }
			 }
			 ...
			 exception.printStackTrace();
			 getErrorMap().put("current",exception
					 .getMessage());
			 throw new ValidatorException(new FacesMessage(exception
					 .getMessage()));
		 } /*finally {
	 ...
	 public void validatePOL_SRC_OF_BUS(FacesContext facesContext,
		 ...
		 CommonUtils.clearMaps(this);
		 try {
			 helper.POL_SRC_OF_BUS_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
			...
			{*/
			 /*Added by saranya on 07-12-2016 for RM018T - FSD_IL_ZB Life_013_Underwriting changes*/ 
			 /*if("075".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_SRC_OF_BUS()) && (!"KIC/".equalsIgnoreCase(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")) || !"TOI/".equalsIgnoreCase(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE"))))KIC condition handled by Ameen on 26-03-2018 for agent prem. less thencalculated prem. error not to come in KIC*/
			 if("075".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_SRC_OF_BUS()) && !CommonUtils.isIN(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE"), "KIC/","TOI/"))
					 {
				 			//compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_FC_AGENT_PREM().setRequired(true);
				 			//compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_LC_AGENT_PREM().setRequired(true);
	 ...
	 public void validatePOL_CUST_CODE(FacesContext facesContext,
		 ...
		 try {
			 ...
			 helper.POL_CUST_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					 (String) value);
...
/*
	 public void defaultBankDetails(String custCode) {
		 ...
		 Connection connection = null;
		 ResultSet resultSet = null;
		 //Modified by ganesh on 23-10-2017 as per suggested by ajoy
		 /*String query = "SELECT CBAD_ACNT_NO,CBAD_MICR_CODE FROM PM_CUST_BANK_ACNT_DTLS WHERE CBAD_CUST_CODE = ? ";*/
		 /*String query = "SELECT CBAD_ACNT_NO,CBAD_MICR_CODE,CBAD_BANK_CODE,CBAD_BANK_NAME FROM PM_CUST_BANK_ACNT_DTLS WHERE CBAD_CUST_CODE = ?";*/
	 /*
		 String query = "SELECT CBAD_ACNT_NO,CBAD_MICR_CODE,CBAD_CUST_BANK_CODE,BANK_NAME FROM PM_CUST_BANK_ACNT_DTLS,FM_BANK WHERE CBAD_CUST_CODE = ? "
		 ...
		 try {
			 connection = CommonUtils.getConnection();
			 resultSet = new CRUDHandler().executeSelectStatement(query,
					 connection, new Object[] { custCode });
			 if (resultSet.next()) {

				 PT_IL_POLICY_BEAN.setPOL_CUST_BANK_CODE(resultSet.getLong(1) == 0?null:resultSet.getLong(1));

				 PT_IL_POLICY_BEAN
				 .setPOL_MICR_CODE(resultSet.getLong(2) == 0 ? null
						 : resultSet.getLong(2));
				//Added by ganesh on 23-10-2017 as per suggested by ajoy
				 PT_IL_POLICY_BEAN.setPOL_BANK_CODE(CommonUtils.nvl(resultSet.getString(3),""));
				 PT_IL_POLICY_BEAN.setUI_POL_BANK_DESC(CommonUtils.nvl(resultSet.getString(4),""));
...
*/
	 ...
	 /*added by gopi for hands on feed back issue,serial no 18 in ZB on 31/01/17*/
	 public void validatePOL_QUOT_NO(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 ...
			 try {
				 ErrorHelpUtil.getWarningForProcedure(CommonUtils
						 .getConnection(), "POL_QUOT_NO", getWarningMap());
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
		 }
	...
	public void validatePOL_ASSRD_REF_ID2(FacesContext facesContext,
		 ...
		 try {
			 ...
			 if("O".equalsIgnoreCase(P_PROD_POL_APPROVAL_YN)){
				 ...
				 ResultSet rs1, rs2;
				 rs1 = new CRUDHandler().executeSelectStatement(query1, CommonUtils.getConnection(), new Object[] {PT_IL_POLICY_BEAN.getPOL_PROD_CODE()});
				 if (rs1.next()) {
					PROD_CALC_TERM_YN = rs1.getString("PROD_CALC_TERM_YN");
				 }
				 rs2 = new CRUDHandler().executeSelectStatement(query2, CommonUtils.getConnection(), new Object[] {PT_IL_POLICY_BEAN.getPOL_NO()});
				 if (rs2.next()) {
				 ...
				 pValList = pkg_pilt002_apac.POL_CONT_CODE_W_V_I(CommonUtils
							...
							CommonUtils.getProcedureValue(PT_IL_POLICY_BEAN
									...
									.getProcedureValue(compositeAction.getPT_IL_POL_ASSURED_DTLS_ACTION_BEAN().getPT_IL_POL_ASSURED_DTLS_BEAN()
				 ...
				 helper.POL_ASSRD_REF_ID2_WHEN_VALIDATE_ITEM(compositeAction,
						 (String) value);
			 }
			 COMP_POL_CUST_CODE.resetValue();
			 COMP_POL_CONT_CODE.resetValue();
...
/*end*/
			 ...
			 /*System.out.println("email  "+compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_EMAIL_ID_PER());
			System.out.println("Phone number "+compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_MOBILE_NO());*/
			 if(getListPhoneEmail().size()>0)
			 {
				 String cust_phone=getListPhoneEmail().get(0);
				 String cust_mail=getListPhoneEmail().get(1);

				 if(CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_RES_EMAIL_ID(), "T").equals("T")&&CommonUtils.nvl(PT_IL_POLICY_BEAN.getPOL_MOBILE_NO(), "T").equals("T")){
					 setEflag(true);
				 }
				 else{
					 setEflag(false);
		...
		PT_IL_POLICY_BEAN.setPOL_RES_EMAIL_ID(cust_mail);
			 ...
			 /*else
			{
			 ...
			 /*if(PT_IL_POLICY_BEAN.getROWID()!=null && !CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_END_CODE(), "GEN012","GEN016"))*/
			 
			 /*
			  * modified by Ameen on 08-05-2018 as per Ajoy sugg.
			  * if(PT_IL_POLICY_BEAN.getROWID()!=null && (PT_IL_POLICY_BEAN.getPOL_END_CODE() != null && !CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_END_CODE(), "GEN012","GEN016")))*/
			 if(PT_IL_POLICY_BEAN.getROWID()!=null && (PT_IL_POLICY_BEAN.getPOL_END_CODE() != null && !CommonUtils.isIN(PT_IL_POLICY_BEAN.getPOL_END_CODE(), "GEN012","CDOB")))
			 /*End*/
			 {
				 ...
				 proclist = helper.P_POL_ASSR_DELT(Pol_Sys_ID,PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1(), Pol_Old_AssuredRefId);
	 ...
	 public void POL_VALIDATE_CUST_MAIL_ID(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 try {
	 ...
	 public void  selectquerymail() throws SQLException, DBException
	 {
		 ...
		 String query= "select cust_phone2, Cust_email_id_per from pm_customer where cust_code='"+cust_code+"' and cust_class IN ('INDL','DC')";
	 ...
	 public void validatePOL_NO(FacesContext facesContext,
		 ...
		 CommonUtils.clearMaps(this);
		 try {
			 /*Newly added by pidugu raj dt: 23-10-2018 for KICLIFEQC-1773914 as per sreeram suggestion*/
			 ...
			 helper.POL_NO_WHEN_VALIDATE_ITEM(
					 PT_IL_POLICY_BEAN.getPOL_DS_TYPE(), (String) value,compositeAction);
	 ...
	 public void validatePOL_PROD_GROUP_CODE(FacesContext facesContext,
		 ...
		 try {
			 ...
			 helper.POL_PROD_GROUP_CODE_WHEN_VALIDATE_ITEM(this,
					 PT_IL_POLICY_BEAN, (String) value);
			 ...
			 try {
				 ErrorHelpUtil.getWarningForProcedure(CommonUtils
						 .getConnection(), "POL_PROD_GROUP_CODE",
						 getWarningMap());
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
	...
	public void validatePOL_PREM_OPTION(FacesContext facesContext,
		...
		try {
			...
			commented by ram
			helper.POL_PLAN_CODE_WHEN_VALIDATE_ITEM(compositeAction,
					(String) value);
			// COMP_POL_PLAN_CODE.resetValue();
			COMP_UI_M_POL_PLAN_DESC.resetValue();
	 ...
	 public String gotoFileUpload() {
		 ...
		 if (PT_IL_POLICY_BEAN != null && PT_IL_POLICY_BEAN.getPOL_NO() != null
			 ...
			 FileUploadAction uploadAction = new FileUploadAction(
					 PT_IL_POLICY_BEAN.getPOL_NO(), PELConstants.pelPolicyTrans,
					 "PILT002_APAC_PT_IL_POLICY", this.getErrorMap());
...
*/
	 public void validatePOL_ISSUE_DT(PILT002_APAC_COMPOSITE_ACTION compositeAction)  {
		 ...
		 try {
			 ...
			 System.out.println("compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_ISSUE_DT()    :  "+compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_ISSUE_DT());
	 ...
	 public void validatePOL_ESC_YN(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 ...
			 try {
				 ErrorHelpUtil.getWarningForProcedure(CommonUtils
						 .getConnection(), "POL_ESC_YN", getWarningMap());
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
		 }
	 ...
	 public void validateAppliedOn(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 ...
			 try {
				 ErrorHelpUtil.getWarningForProcedure(CommonUtils
						 .getConnection(), "POL_FLEX_09", getWarningMap());
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
		 }
	 ...
	 public void validatePOL_CVR_ESC_PERC(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 ...
			 try {
				 ErrorHelpUtil.getWarningForProcedure(CommonUtils
						 .getConnection(), "POL_CVR_ESC_PERC", getWarningMap());
			 } catch (Exception e) {
				 e.printStackTrace();
			 }
		 }
	 ...
	 public ArrayList<LovBean> lovPOL_CUST_CODE(Object object) {
		 ...
		 try {
			 ...
			 if (("1".equals(compositeAction.getDUMMY_ACTION_BEAN()
					 .getDUMMY_BEAN().getUI_M_CALC_METHOD()) || "2"
					 .equals(compositeAction.getDUMMY_ACTION_BEAN()
				 ...
				 if ("N".equals(CommonUtils.nvl(PT_IL_POLICY_BEAN
					 ...
					 if ("N".equals(CommonUtils.nvl(M_FACIN_YN, "N"))) {
						 ...
						 values = new Object[] {
								 PT_IL_POLICY_BEAN.getPOL_DIVN_CODE(),
								 currentValue, currentValue, currentValue };
						 suggestionList = ListItemUtil.prepareSuggestionList(
								 mainQry, values);
					 ...
					 mainQry = prepareCustomerQuery(mainQry,
							 new Object[] { "CASH" });
					 values = new Object[] {
							 PT_IL_POLICY_BEAN.getPOL_DIVN_CODE(), currentValue,
	 ...
	 public ArrayList<com.iii.premia.common.bean.LovBean> lovPOL_PAYOR_SDCODE(
			 Object object) {
	 ...
	 public String getToggleState() {
		 System.out
		 .println("PT_IL_POLICY_ACTION.getToggleState()" + toggleState);
		 return toggleState;
	 }

	 public void setToggleState(String toggleState) {
		 System.out
		 .println("PT_IL_POLICY_ACTION.setToggleState()" + toggleState);
	 ...
	 private void validateOtherRichTabComponents() throws ValidatorException {
		  ...
		  */if (COMP_POL_RES_ADDRESS_1.getValue() == null
		   ...
		   */if (COMP_POL_TARIFF_TERM_FLAG.getValue() == null
			   ...
			   throw new ValidatorException(new FacesMessage("Tariff Term Flag "
					   + Messages.getString(PELConstants.pelMessagePropertiesPath,
							   "javax.faces.component.UIInput.REQUIRED")));
		   }
		   if ("M".equals(compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN()
				   .getUI_M_POL_PLAN_TYPE())) {
			   if (COMP_POL_CREDIT_INT_RATE.getValue() != null
					   && !"".equals(COMP_POL_CREDIT_INT_RATE.getValue())) {
	 ...
	 public void disableAllComponent(boolean disabled) {
		...
		COMP_UI_M_POL_PREM_PAYER_CODE_DESC.setDisabled(disabled);
		 /*end*/
		 /*Added by saranya on 02-11-2016 for  RM018T - FSD_IL_ZB Life_013_Underwriting changes */
		 ...
		 if ("U".equals(compositeAction.getDUMMY_ACTION_BEAN().getDUMMY_BEAN()
				 .getUI_M_POL_PLAN_TYPE())) {
		...
		// COMP_POL_ISSUE_DT.setDisabled(disabled);
		 ...
		 /*Added by saritha on 19-12-2016 RM018T -DEV_IL_ZB Life_015-Lapsation and commission clawback 2*/
		 /*if((PT_IL_POLICY_BEAN.getPOL_NO() != null)&&(PT_IL_POLICY_BEAN.getPOL_END_TYPE() != null)&&(PT_IL_POLICY_BEAN.getPOL_END_TYPE().equals("001"))&&(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG().equals("Y"))){
			 COMP_POL_LAPS_OVR_YN.setDisabled(false);
		 }
		 else {
			 COMP_POL_LAPS_OVR_YN.setDisabled(disabled);
		 }*/
		 ...
		 /* Newly Added By Dhinesh on 12-06-2017 for Change in lapsation Overriding Endorsement Issues */
			...
			/*if("001".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_TYPE()) && "GEN008".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_END_CODE()) && "Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG()) )
			{
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_LAPS_OVR_YN().setDisabled(true);	
				compositeAction.getPT_IL_POLICY_ACTION_BEAN().getCOMP_POL_LAPS_OVR_DT().setDisabled(true);
			}
		 ...
		 /*Added by saritha on 19-12-2016 RM018T -DEV_IL_ZB Life_015-Lapsation and commission clawback 2*/
		/*if((PT_IL_POLICY_BEAN.getPOL_NO() != null)&&(PT_IL_POLICY_BEAN.getPOL_END_TYPE() != null)&&(PT_IL_POLICY_BEAN.getPOL_END_TYPE().equals("001"))&&("Y".equals(PT_IL_POLICY_BEAN.getPOL_LAPS_OVR_YN()))){			 
			 COMP_POL_LAPS_OVR_DT.setDisabled(false);			 
		 }else{
		 COMP_POL_LAPS_OVR_DT.setDisabled(disabled);
		 }*/
		 /* End*/
	 ...
	 public void setCOMP_POL_CREDIT_INT_RATE_MANDATORY(
			 HtmlGraphicImage comp_pol_credit_int_rate_mandatory) {
			...
			/* if(resourceBundle.getString("isJasperReports") != null)
			 {
				 ...
				 {
					 CommonUtils.setGlobalObject("PILP016_COMPOSITE_ACTION", new com.iii.pel.forms.PILP016_F.PILP016_COMPOSITE_ACTION());  // ADDED BY SANKARA NARAYANAN ON 16-02-2017		 
				 }
				 else
				 {
					 Added by Sankar on 15.02.2017 for ZB schedule
					 CommonUtils.setGlobalObject("PILP016_COMPOSITE_ACTION", new com.iii.pel.forms.PILP016.PILP016_COMPOSITE_ACTION());  // ADDED BY SANKARA NARAYANAN ON 16-02-2017
					 End
				 }
			 }*/
			 ...
			 /*ENd*/
			 /*Added by Sankar on 15.02.2017 for ZB schedule*/
			 CommonUtils.setGlobalObject("PILP016_COMPOSITE_ACTION", new PILP016_COMPOSITE_ACTION());  // ADDED BY SANKARA NARAYANAN ON 16-02-2017
	 ...
	 public String onclickCancel() {
		 ...
		 .getCOMP_REPORT_MODAL_PANEL_ASSURED()
		 .setShowWhenRendered(false);
		 
		 /*Added by saritha on 06-04-2018 for KIC Pop up message that the customer/Assured is already exist once ID is entered is required &
 ...
 /*Added by Janani on 30-05-2017 for ZBILQC-1719696��*/
		 ...
		 .setValue(Messages.getString(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")+"messageProperties_PM006_QE","PM006_A_APAC$PM_CUSTOMER_QE$DISPLAY$caption"));
		 /*End*/
		 try {
			 ...
			 if (PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1() != null
				 ...
				 * if ("A".equalsIgnoreCase(PT_IL_POLICY_BEAN
						 .getPOL_APPRV_STATUS())
						 || "Y".equalsIgnoreCase(PT_IL_POLICY_BEAN
								 .getPOL_FRZ_FLAG())) {
				 ...
				 /*
				  * modified by Ameen to change the sys. param. to enable/diasble cust. creation fields as per Kuzhandhai sir sugg.
				 ...
				 }else if(param_type_Cust == 2){ /*else if condition handled by Ameen on 03-05-2018 for KIC*/
					 
					 if ("N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS()) && "N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG())
							 && PT_IL_POLICY_BEAN.getPOL_END_NO_IDX() != null && PT_IL_POLICY_BEAN.getPOL_END_NO_IDX() == 0) {
				...
				/*End*/
				 ...
				 .disableAllComponent(false);
				 		...
				 		System.out.println("teeeeeeeesssstttttttt : " + CommonUtils
								.getGlobalVariable("GLOBAL.M_PARAM_20"));
						compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().setCUST_CLASS( CommonUtils
								.getGlobalVariable("GLOBAL.M_PARAM_20"));
						compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().setUI_M_CUST_CCLAS_DESC("Individuals");
						...
						/*Added by Ameen on 19-04-2018 for KIC to default nationality as per Vijay sugg.*/
						ResultSet nationRS = new CRUDHandler().executeSelectStatement("SELECT PC_CODE FROM  PM_CODES  WHERE  PC_TYPE  = 'NATLITY'  AND PC_VALUE  = 1 ", 
												CommonUtils.getConnection());
						if(nationRS.next()){
							compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().setCUST_NATIONALITY_CODE(nationRS.getString("PC_CODE"));
						}
						String nationalityDesc = P_VAL_CODES
								.P_VAL_CODES(
										CommonUtils.getConnection(),
										"NATLITY",
										compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_NATIONALITY_CODE(),
										"N",
										"N");
						compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().setUI_M_CUST_NATIONALITY_CODE_DESC(nationalityDesc);
						/*End*/
						
			 }
			 System.out.println("LINE 12447 ");	
			 /*
			  * commented by Ameen on 02-03-2018 for KIC that to Display customer screen for projects
			  * compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN()
			 .getCOMP_REPORT_MODAL_PANEL_CUSTOMER().setShowWhenRendered(
					 true);*/
	 ...
	 * public String assuredModalPanel() {
		 ...
		 //End
		 //OUTCOME HANDLED BY aMEEN ON 26-02-2018 FOR KIC
		 String outcome = "";
		 //eND
		 
		 try {
			 PM_IL_CONTRACTOR_HELPER_QE assuredHelper = compositeAction
			 ...
			 if (PT_IL_POLICY_BEAN.getPOL_CONT_CODE() != null
				...
				// }
				 ...
				 System.out.println("param_type_Cust in assured panel             :"+param_type_Cust);
				 ...
				 {
					 //Added by raja on 06-03-2017 for ZBILQC-1719062
					 compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN()
					 .disableAllComponent(true);
					 //end
				...
				//End
				 ...
				 .getCOMP_REPORT_MODAL_PANEL_CUSTOMER().setShowWhenRendered(
				  ...
				  //commented by Ameen on 02-03-2018 to show Assured screen for every project
				  //compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN()
				 //.getCOMP_REPORT_MODAL_PANEL_ASSURED().setShowWhenRendered(
						 //true);
	...
	/* public String assuredModalPanel() {
		 ...
		 try {
			 ...
			 CommonUtils.setGlobalVariable("CALL_FORM_FOR_CUST", "PILT002_APAC");
				 ...
				 if(PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG()!=null && PT_IL_POLICY_BEAN.getUI_POL_FRZ_FLAG().equalsIgnoreCase("Y"))
				 {
					 compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().disableAllComponent(true);
					// compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().resetAllComponent();
				 }else
				 {
					 compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().disableAllComponent(false);
				 }
	 ...
	 public String assuredModalPanel() {
				 ...
				 compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getCOMP_HEADER_LABEL()
				 .setValue(Messages.getString(CommonUtils.getGlobalVariable("GLOBAL.SITE_CODE")+"messageProperties_PM006_QE","PM006_A_APAC$PM_CUSTOMER_QE$DISPLAY_ASSURED$caption"));
				 /*End*/
				 try {
					 PM006_QE_CUSTOMER_HELPER custHelper = compositeAction
							 .getPM006_QE_CUSTOMER_ACTION_BEAN().getHelper();
					 ...
					 CommonUtils.setGlobalVariable("CALL_FORM_FOR_CUST", "PILT002_APAC");
					 if (PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2() != null
							 && !"".equals(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2()) 
							 && (!PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2().equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1()) 
									 || null!=PT_IL_POLICY_BEAN.getPOL_SYS_ID())) {
						 
						 compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN()
						 .getPM006_QE_CUSTOMER_BEAN().setCUST_REF_ID2(
						 ...
						 .disableAllComponent(false);
								...
								/*if(compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_REF_ID1() != null){
									CommonUtils.setGlobalVariable("GLOBAL.REFID2", 
											compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_REF_ID1());
	 ...
	 public void setCOMP_POL_ESC_PERCENTAGE_LABEL(
			 HtmlOutputLabel comp_pol_esc_percentage_label) {
	 ...
	 public void setCOMP_POL_CVR_ESC_PERC_LABEL(
			 HtmlOutputLabel comp_pol_cvr_esc_perc_label) {
	 ...
	 public void setCOMP_UI_M_BUT_DOCUMENTS(
			 HtmlCommandButton comp_ui_m_but_documents) {
	 ...
	 public void setCOMP_POL_STD_SUBSTD_LABEL(
			 HtmlOutputLabel comp_pol_std_substd_label) {
			 ...
			 if ("UI_M_ENDT_LETTER".equals(input)) {
				 ...
				 if (IP_REP_INFO_BEAN.getSelectedFileType() != null) {
					 ...
					 if (IP_REP_INFO_BEAN.getROWID() == null) {
						 IP_REP_INFO_BEAN.setREP_VALUE_1(String
								 .valueOf(PT_IL_POLICY_BEAN.getPOL_SYS_ID()));

						 IP_REP_INFO_BEAN.setREP_ID("RICBL_SCH_19");
						 IP_REP_INFO_BEAN.setREP_KEY_NO(new ReportUtils()
						 .getRepKeyNo());
						 new CRUDHandler().executeInsert(IP_REP_INFO_BEAN,
								 CommonUtils.getConnection());
						 CommonUtils.getConnection().commit();
					 }
					 map.put("P_COMP_CODE", CommonUtils
							 .getGlobalVariable("GLOBAL.M_COMP_CODE"));
					 response = (HttpServletResponse) FacesContext
							 .getCurrentInstance().getExternalContext()
							 .getResponse();
					 redirectUrl = ReportUtils.getReportRedirectString(
							 IP_REP_INFO_BEAN.getREP_KEY_NO(), IP_REP_INFO_BEAN
							 .getREP_ID(), IP_REP_INFO_BEAN.getREP_ID(),
	 ...
	 public void enableDisableRSA() throws Exception {
		 ...
		 try {
			 connection = CommonUtils.getConnection();
			 System.out.println("PT_IL_POLICY_BEAN.getPOL_PLAN_CODE()          "+PT_IL_POLICY_BEAN
					 .getPOL_PLAN_CODE());
			 resultSet = new CRUDHandler().executeSelectStatement(query,
			 ...
			 if ("M".equals(planType)) {
				 ...
				 .getCOMP_UI_M_BUT_RD_SA1().setRendered(true);
				 System.out.println("RSA----->" + planType);
			 } else {
				 compositeAction.getPT_IL_POL_RED_SA_ACTION_BEAN()
				 .getCOMP_UI_M_BUT_RD_SA1().setRendered(false);
			 }
		 } catch (DBException e) {
			 e.printStackTrace();
			 throw e;
	 ...
	 public void setCOMP_POL_MICR_CODE_LABEL(
			 HtmlOutputLabel comp_pol_micr_code_label) {
	 ...
	 public void setCOMP_POL_CUST_BANK_CODE_LABEL(
			 HtmlOutputLabel comp_pol_cust_bank_code_label) {
	 ...
	 public void setCOMP_UI_M_CITY_CODE_DESC(
			 HtmlInputText comp_ui_m_city_code_desc) {
	 ...
	 public void setCOMP_UI_M_BANK_CODE_DESC_1(
			 HtmlInputText comp_ui_m_bank_code_desc_1) {
	 ...
	 public void setCOMP_UI_M_BRANCH_CODE_DESC_1(
			 HtmlInputText comp_ui_m_branch_code_desc_1) {
	 ...
	 public void validateMICRCODE(FacesContext context, UIComponent component,
			 Object value) {
		 ...
		 try {
			 ...
			 PT_IL_POLICY_BEAN.setUI_M_BRANCH_CODE_DESC_1(getBranchDesc(
					 branchcode, bankcode, citycode));
	 ...
	 public void defaultMICRDetails() throws Exception {
		 try {
			 ...
			 if (PT_IL_POLICY_BEAN.getPOL_MICR_CODE() != null) {
				 String str = String.valueOf(PT_IL_POLICY_BEAN
						 .getPOL_MICR_CODE());
				 if (str.length() == 9) {
					 citycode = str.substring(0, 3);
					 bankcode = str.substring(3, 6);
					 ...
					 PT_IL_POLICY_BEAN.setUI_M_BRANCH_CODE(branchcode);
					 PT_IL_POLICY_BEAN
					 .setUI_M_CITY_CODE_DESC(getCityDesc(citycode));
					 PT_IL_POLICY_BEAN
					 .setUI_M_BANK_CODE_DESC_1(getBankDesc(bankcode));
					 PT_IL_POLICY_BEAN.setUI_M_BRANCH_CODE_DESC_1(getBranchDesc(
							 branchcode, bankcode, citycode));
				 }
			 }
	 ...
	 public String getCityDesc(String cityCode) throws Exception {
		 ...
		 try {
			 connection = CommonUtils.getConnection();
			 resultSet = new CRUDHandler().executeSelectStatement(query,
					 connection, new Object[] { cityCode });
			 if (resultSet.next()) {
	 ...
	 public String getBranchDesc(String branchCode, String bank, String cityCode)
			 throws Exception {
		 Connection connection = null;
		 ResultSet resultSet = null;
		 String desc = null;
		 ...
		 try {
			 connection = CommonUtils.getConnection();
			 resultSet = new CRUDHandler().executeSelectStatement(query,
					 connection, new Object[] { branchCode, bank, cityCode });
			 if (resultSet.next()) {
				 desc = resultSet.getString(1);
			 }
		 } catch (DBException e) {
	 ...
	 public void chkDthClaim(String polno) throws Exception {
		 Connection connection = null;
		 ResultSet resultSet = null;
		 String query = "SELECT 'X'  FROM   PT_IL_CLAIM WHERE "
				+ " CLAIM_POL_NO = ?  AND    CLAIM_TYPE IN ('A','D')"
				+ "AND NVL(CLAIM_MEMB_CODE,CLAIM_ASSR_CODE) = NVL(CLAIM_ASSR_CODE,'XXX')";
		 try {
			 connection = CommonUtils.getConnection();
			 resultSet = new CRUDHandler().executeSelectStatement(query,
					 connection, new Object[] { polno });
			 if (resultSet.next()) {
				 compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_ENDT()
				 .setDisabled(true);
			 }
			/*
			 * 
			 *  Commented By Dhinesh on 19-9-2017 for ssp call id : ZBILQC-1737294 Point No : 2
			 *  
			 *  else
			 {
				 compositeAction.getDUMMY_ACTION_BEAN().getCOMP_UI_M_BUT_ENDT()
		 ...
		 if ("012".equalsIgnoreCase(CommonUtils.nvl(pt_il_policy_bean
			 ...
			 if (pt_il_policy_bean.getPOL_PERIOD() != 0) {
				 ...
				 try {
					 Connection connection = CommonUtils.getConnection();
					 resultSet = new CRUDHandler().executeSelectStatement(Query,
							 connection, new Object[] { polFromDt, polPeriod });
					 if (resultSet.next()) {
						 polExpiryDate = resultSet.getDate(1);
					 }
					 if (polExpiryDate.equals(pt_il_policy_bean
							 .getPOL_EXPIRY_DT())) {
						 // do nothing
					 } else {
	 ...
	 public void END_001changes(){
		 if("001".equalsIgnoreCase(CommonUtils.nvl(PT_IL_POLICY_BEAN
				 .getPOL_END_TYPE(), "000"))&& "N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS())){
			 ...
			 /*Modified by Janani on 27.06.2018 for FLA as per Chandramohan sugges*/
			 //if("AD".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE()) || "S".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_PYMT_TYPE()))
			...
			getPT_IL_POLICY_BEAN().setUI_M_POL_CUST_DESC(PT_IL_POLICY_BEAN.getUI_M_POL_CUST_DESC());
			}
			else{
				getPT_IL_POLICY_BEAN().setUI_M_POL_CUST_DESC(PT_IL_POLICY_BEAN.getPOL_ASSURED_NAME());
			}*/
		 }
		 /*else{
			COMP_UI_M_POL_CUST_DESC.setDisabled(true);
		}*/
	 ...
	 public void setCOMP_POL_RES_EMAIL_ID_LABEL(
			 HtmlOutputLabel cOMP_POL_RES_EMAIL_ID_LABEL) {
	 ...
	 public void  addcontent(ActionEvent actionEvent){
		 ...
		 System.out.println("*******************value of addcontent------------------------>"+PT_IL_POLICY_BEAN.getPOL_END_DESC());
	 }
	 ...
	 public void validatePOL_EMR_RATE(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
	 ...
	 public void validatemethod() throws Exception
	 {
		 if(PT_IL_POLICY_BEAN.getPOL_END_DESC()==null){
			 ...
			 /*String End_Desc="SELECT DS_END_REASON FROM PM_IL_DOC_SETUP WHERE DS_TYPE = '3' AND DS_CODE = ?";*/
	 ...
	 public void validateUI_M_POL_CUST_DESC(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 String code = (String) value;
	 ...
	 public void validatePOL_ASSURED_NAME(FacesContext facesContext,
			 UIComponent component, Object value) throws ValidatorException {
		 CommonUtils.clearMaps(this);
		 try {
			 String code = (String) value;
	 ...
	 public void END_FIELD_DISABLED(String polStatus,String frzFlag,String endType) throws Exception {
		 	...
		 	if(polStatus.equalsIgnoreCase("E") && frzFlag.equalsIgnoreCase("N")){
				 ...
				 if(endType.equalsIgnoreCase("GEN004")){
					 	...
					 	COMP_POL_FRZ_FLAG.setDisabled(false);
					 	compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().disableAllComponent(false);
					 	/*compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().getCOMP_UI_M_BANK_CODE().setDisabled(false);
						compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().getCOMP_UI_M_BRANCH_CODE().setDisabled(false);*/
					 	compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setUPDATE_ALLOWED(true);
				    	compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setINSERT_ALLOWED(true);
				    	compositeAction.getPT_IL_POL_BENEFICIARY_ACTION_BEAN().setDELETE_ALLOWED(true);
				 ...
				 if((endType.equalsIgnoreCase("INCPREM") || endType.equalsIgnoreCase("DECPREM"))){
					 ...
					 String premCalcType = compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_UL_PREM_CALC();					 
					 if("A".equalsIgnoreCase(premCalcType)){ //Premium From benefit
				...
				/* if(endType.equalsIgnoreCase("ALTERM")){*/
				 ...
				 if(endType.equalsIgnoreCase("ALTERM") || endType.equalsIgnoreCase("INCTERM") || endType.equalsIgnoreCase("DECTERM")){
				 ...
				 /*End*/
					...
					// COMP_POL_FRZ_FLAG.setDisabled(false);
					 ...
					 /*Added by saritha on 17-05-2018 for In Incressing/Decreasing in Term Endorsement need to enable for Rider*/
 ...
 /*added by raja on 17-05-2017 for addition of dependant*/
				 ...
				 if(endType.equalsIgnoreCase("ADDDEP")){
					...
					// COMP_POL_FRZ_FLAG.setDisabled(false);
					 ...
					 compositeAction.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN().setDELETE_ALLOWED(false);
					 compositeAction.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN().setUPDATE_ALLOWED(false);
					 /*Added by ganesh as suggested on 06-10-2017 as suggestd by thiags from onsite*/
				 ...
				 /*Added by ganesh on 15-06-2017, as suggested by ajoy to enable payment type */
				 ...
				 if(endType.equalsIgnoreCase("CDOB")){
					...
					// COMP_POL_FRZ_FLAG.setDisabled(false);
					 ...
					 compositeAction.getPT_IL_POL_FUNERAL_MEMB_DTLS_ACTION_BEAN().getCOMP_PFMD_MEMB_TYPE().setDisabled(false);
					 /*end*/
					 ...
					 /*Added by Janani on 04.06.2018 for Product feature as per Sivaram's suggestion*/
				...
				/*End*/
				 ...
				 if(getPT_IL_POLICY_BEAN().getPOL_END_TYPE()!=null && getPT_IL_POLICY_BEAN().getPOL_END_TYPE().equalsIgnoreCase("001"))
						 {
					 COMP_POL_FRZ_FLAG.setDisabled(false);
						 }
				 else
				 ...
				 /*Added by Janani on 12.03.2018 for FSD_FLA_IL_008(GEN010 endorsement)*/
				 
				 System.out.println("endType               "+endType+"       getChkEndCode          "+this.getChkEndCode());
				 ...
				 if(getPT_IL_POLICY_BEAN().getPOL_END_TYPE()!=null && getPT_IL_POLICY_BEAN().getPOL_END_TYPE().equalsIgnoreCase("021"))
				 {
					 disbaleFields.IL_BLOCK_POL_DISABLED(compositeAction);
					 setUPDATE_ALLOWED(true);
					 setINSERT_ALLOWED(true);
	...
	//Added By Ameen 12.9.2016 for ssp call id : FALCONQC-1714579 ---END ---
	 ...
	 /*    Addded By Dhinesh for ssp call id FALCONQC-1716975   */
		...
		public static void COVER_SUM_SA_Validation(String Pol_sys_id,String Prod_code,String Pol_End_Type ,String Pol_End_Code) throws Exception
		{
			...
			while (resultSet.next()) {
				...
				System.out.println("outputList  MIN SA   : "+outputList.get(0).getValueObject());
			         ...
			         {
			        	if(CommonUtils.isIN(CommonUtils.nvl(Pol_End_Type,"000"), new String[]{"000","002","012"}) && (CommonUtils.nvl(Pol_End_Code,"XXX")!=Psvalue)) 
			        	{
			        		if(TOT_POAC_FC_SA > Double.parseDouble(outputList.get(1).getValueObject().toString()))
			    			{
			    						        			
			        			System.out.println("MAX VALUE BLOCK");
			    				throw new Exception(POAC_COVER_CODE+" Cover Sum Assured exceeds the Max limit in Cover Master.");
			        		...
			        		if(TOT_POAC_FC_SA < Double.parseDouble(outputList.get(0).getValueObject().toString()))
			    			{
			    				...
			    				throw new Exception(POAC_COVER_CODE+" Cover Sum Assured Less than Min limit in Cover Master.");
...
/*End*/
		...
		public void getProd_plan_type() throws Exception
		{
			...
			/*QUERY CHANGED BY SANKARA NARAYANAN ON 28/03/2017
			 * String query="SELECT PLAN_TYPE FROM PM_IL_PLAN WHERE PLAN_CODE = ?";*/
			 ...
			 * 
			 * resultSet1 = new CRUDHandler().executeSelectStatement(query, connection, new Object[]{PT_IL_POLICY_BEAN.getPOL_PLAN_CODE()});*/
			resultSet1 = new CRUDHandler().executeSelectStatement(query, connection, new Object[]{PT_IL_POLICY_BEAN.getPOL_PLAN_CODE(),PT_IL_POLICY_BEAN.getPOL_PROD_CODE()});
			/*End*/
			while(resultSet1.next())
			{
		...
		public void validatorPOL_LOAN_TYPE(FacesContext context,
				UIComponent component, Object value) {
			try {
		...
		try {
			...
			//Iterator<String> scheduleITRforDel = getUI_M_SCHEDULE_TYPE().iterator();
			...
			//{
			//reportNamesForDel = reportNamesForDel.substring(0,reportNamesForDel.length()-1);
			//System.out.println("reportNamesForDel  "+reportNamesForDel);
			//String deleteQuestionQuery = "DELETE FROM PT_IL_POL_BR_QUESTION WHERE PBQ_POL_SYS_ID = ? AND PBQ_QUEST_REP_NAME NOT IN (?)";
			//new CRUDHandler().executeDeleteStatement(deleteQuestionQuery, conn,new Object[]{getPT_IL_POLICY_BEAN().getPOL_SYS_ID(),reportNamesForDel});
			//conn.commit();
			//}
			...
			new CRUDHandler().executeDeleteStatement(deleteQuestionQuery, conn,new Object[]{getPT_IL_POLICY_BEAN().getPOL_SYS_ID()});
			conn.commit();
			...
			while(scheduleITR.hasNext())
			{
				...
				String categoryQuery = " SELECT PC_TYPE FROM PM_CODES WHERE PC_TYPE IN (SELECT PC_CODE FROM PM_CODES WHERE PC_TYPE = 'IL_QUEST_TYP') AND "
						+ "PC_CODE = ? ";
				ResultSet rs = new CRUDHandler().executeSelectStatement(categoryQuery, conn,new Object[]{reportName});
				while(rs.next())
				{
				...
				System.out.println("getPT_IL_POLICY_BEAN().getPOL_SYS_ID()          "+getPT_IL_POLICY_BEAN().getPOL_SYS_ID()+"      "+reportName);
				rs = new CRUDHandler().executeSelectStatement(QuestionarieSeqQuery, conn,new Object[]{getPT_IL_POLICY_BEAN().getPOL_SYS_ID(),reportName});
				if(rs.next())
				{
				...
				System.out.println("getPT_IL_POL_BR_QUESTION_BEAN().getPBQ_SYS_ID        "+getPT_IL_POL_BR_QUESTION_BEAN().getPBQ_SYS_ID());
				...
				System.out.println("getPT_IL_POL_BR_QUESTION_BEAN().getPBQ_QUEST_TYPE     "+getPT_IL_POL_BR_QUESTION_BEAN().getPBQ_QUEST_TYPE()+"  "+
		...
		public void setCOMP_POL_BUS_REMARKS_LABEL(
				HtmlOutputLabel cOMP_POL_BUS_REMARKS_LABEL) {
			COMP_POL_BUS_REMARKS_LABEL = cOMP_POL_BUS_REMARKS_LABEL;
		}
		
		public void validatePOL_BUS_REMARKS(FacesContext facesContext,
				UIComponent component, Object value) throws ValidatorException {
			CommonUtils.clearMaps(this);
			try {
		...
		public void setPT_IL_POL_BR_QUESTION_BEAN(
				PT_IL_POL_BR_QUESTION pT_IL_POL_BR_QUESTION_BEAN) {
	...
	/*Added by saranya on 02-11-2016 for  RM018T - FSD_IL_ZB Life_013_Underwriting changes */
		...
		public void validatePOL_FC_AGENT_PREM(FacesContext facesContext,
				UIComponent component, Object value) throws ValidatorException {
			try {
		...
		public void validatePOL_CANCEL_YN(FacesContext facesContext,
				UIComponent component, Object value) throws ValidatorException {
			try{
				checkCancelYN(PT_IL_POLICY_BEAN,compositeAction);
				String CurValue=(String)value;
			//	System.out.println("PT_IL_POLICY_BEAN.getPOL_CANCEL_YN()  :"+PT_IL_POLICY_BEAN.getPOL_CANCEL_YN());
		...
		/*End*/
		/*added by saranya on 19-12-2016 for RM018T - FSD_IL_ZB Life_016-Queried Proposals v1.0*/
		String Cancel_YN=null;
		public void checkCancelYN(PT_IL_POLICY pt_il_policy_bean,
		...
		public void setCOMP_POL_LAPS_OVR_YN_LABEL(
				HtmlOutputLabel cOMP_POL_LAPS_OVR_YN_LABEL) {
		...
		public void validatePOL_LAPS_OVR_YN(FacesContext context,
				UIComponent component, Object value)  {
			CommonUtils.clearMaps(this);
		...
		public void setCOMP_POL_LAPS_OVR_DT_LABEL(
				HtmlOutputLabel cOMP_POL_LAPS_OVR_DT_LABEL) {
		...
		public void validatePOL_LAPS_OVR_DT(FacesContext facesContext,
				UIComponent component, Object value) throws ValidatorException {
			Date curDate = (Date) value;
			try
			{
...
/*Added by R. Raja on 02-12-2016 for RM018T - FSD_IL_ZB Life_002-Customer Master Changes COMMENTS*/
		...
		public void setCOMP_UI_M_POL_PREM_PAYER_CODE_DESC(
				HtmlInputText cOMP_UI_M_POL_PREM_PAYER_CODE_DESC) {
		...
		public void setCOMP_POL_PREM_PAYER_CODE_LABEL(
				HtmlOutputLabel cOMP_POL_PREM_PAYER_CODE_LABEL) {
			COMP_POL_PREM_PAYER_CODE_LABEL = cOMP_POL_PREM_PAYER_CODE_LABEL;
		}
		
		
		 public void validatePOL_PREM_PAYER_CODE(FacesContext facesContext,
				 UIComponent component, Object value) throws ValidatorException {
			 CommonUtils.clearMaps(this);
			 try {
		...
		/*end*/
		 ...
		 /*added by gopi for RM018T - DEV_IL_ZB Life_022-Automated Premium Loan*/
			...
			public void setCOMP_POL_REPLACEMENT_YN_LABEL(
					HtmlOutputLabel cOMP_POL_REPLACEMENT_YN_LABEL) {
			...
			public void validatePOL_REPLACEMENT_YN(FacesContext context,
					UIComponent component, Object value)  {
			...
			/*End*/
			/*Added by saranya for RM018T - FSD_IL_ZB Life_001-Education Endowment Plan COMMENTS on 26-01-2017*/	
			public void validatePOL_BNF_ESC_PERC(FacesContext context,
					UIComponent component, Object value)  {
				String CurValue=(String)value;
				try {
			...
			public void validatePOL_ANN_PAY_PERIOD(FacesContext context,
					UIComponent component, Object value)  {
				String CurValue = (String) value;
				try {
			...
			public void setCOMP_POL_ANN_BNF_AMT_LABEL(
					HtmlOutputLabel cOMP_POL_ANN_BNF_AMT_LABEL) {
			...
			public void validatePOL_ANN_BNF_AMT(FacesContext context,
					UIComponent component, Object value)  {
			...
			public void setCOMP_POL_DISPATCH_MTD_LABEL(
					HtmlOutputLabel cOMP_POL_DISPATCH_MTD_LABEL) {
			...
			/*Added by sankaranarayanan for ZBILQC-1721052 on 27-03-2017*/
			 ...
			 public void validatePOL_DISPATCH_MTD(FacesContext facesContext,
					 UIComponent component, Object value) throws ValidatorException {
				 CommonUtils.clearMaps(this);
				 try {
					 String Currvalue=((String) value);
					 if("001".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_SRC_OF_BUS())){
						 if("A".equalsIgnoreCase(Currvalue)){
							 /*
							  * modified by Ameen on 07-02-2018 for KIC as per SreeRam sir sugg.
							  * throw new Exception("You can't able to select because you are the Direct Customer");*/
			 ...
			 /*end*/
				...
				public void setCOMP_POL_UL_PREM_CALC_LABEL(
						HtmlOutputLabel cOMP_POL_UL_PREM_CALC_LABEL) {
				...
				public void validatePOL_UL_PREM_CALC(FacesContext context,
						UIComponent component, Object value)  {
					String CurValue = (String) value;
					try {
						...
						/*Modified by Janani on 25.06.2018 for  FSD_IL_FLA_006_Monetary Endorsement Module*/
						...
						Unit_link_typ();
						String Unit_link_typ= getUnit_link_typ();
						if((!"NA".equalsIgnoreCase(Unit_link_typ))&&("N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_UL_PREM_CALC()))){
							/*getErrorMap().put(PELConstants.PEL_ERROR_WARNING_CURRENT_KEY, "NOT A VALID OPTION");*/
...
/*				public void setPremiumCalculationType()
				...
				public void setPremiumCalculationType()
				{
					...
					try {
						...
						if(("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_UL_PREM_CALC()))&&
							...
							COMP_POL_FC_SUM_ASSURED.setDisabled(true);
							/*Commented by ganesh on 25-07-2017, as per anbarasi suggestion ZBILQC-1732654 */
							...
							COMP_POL_FC_SUM_ASSURED.setDisabled(true);
							COMP_POL_ANN_BNF_AMT.setDisabled(true);
							/*Commentted by saritha on 23-08-2017 for Education Product Issues*/
							/*PT_IL_POLICY_BEAN.setPOL_ANN_BNF_AMT(null);
						    COMP_POL_ANN_BNF_AMT.resetValue();*/
							/*End*/
				...
				/*Added by ameen on 28-03-2017 to default the expiry date to effective from date*/
				public void onLoadEndorsement(PhaseEvent event) {
					
					
					 
					try {
						
						/*Added by ganesh on 06-09-2017, to enable ok button only on POL_APPRV_STATUS is Approved other than disabled.suggested by ajoy*/
						...
						PT_IL_POLICY_BEAN.setPOL_END_EFF_TO_DT(PT_IL_POLICY_BEAN.getPOL_EXPIRY_DT());
						System.out.println("ONLOADEND-->"+PT_IL_POLICY_BEAN.getPOL_START_DT()+","+PT_IL_POLICY_BEAN.getPOL_END_EFF_FROM_DT()+","+PT_IL_POLICY_BEAN.getPOL_EXPIRY_DT());
						COMP_POL_END_EFF_TO_DT.resetValue();
						/*Added by ganesh on 30-03-2017 to setting the Endorsement eff. from date based on the system parameter.
						 * 1- set Policy start date
				 ...
				 public void fetchNextAnniversaryRenewalDate() throws SQLException, DBException
					{
						...
						rs = new CRUDHandler().executeSelectStatement("SELECT MAX(PC_SCHD_PYMT_DT) FROM PT_IL_PREM_COLL WHERE PC_POL_SYS_ID = ? AND PC_PREM_TYPE = 'R' AND PC_PAID_FLAG = 'N'", CommonUtils.getConnection(),
								new Object[]{PT_IL_POLICY_BEAN.getPOL_SYS_ID()});
						if(rs.next())
						{
				...
				/*end*/
				 ...
				 /*ADDED BY SANKARA NARAYANAN ON 28/03/2017*/
					...
					public void bankDetailsDefaulting(String submittedPOL_CUST_CODE){
						...
						/*String qry = "SELECT CBAD_ACNT_NO, CBAD_BANK_CODE, CBAD_BANK_NAME, CBAD_CITY_CODE, CBAD_DIVISION,CBAD_ACNT_NAME "
								+ "FROM PM_CUST_BANK_ACNT_DTLS WHERE CBAD_CUST_CODE = ? AND CBAD_PREF_ACNT_YN = 'Y'";*/
						/*String qry = "SELECT CBAD_ACNT_NO, CBAD_CUST_BANK_CODE, CBAD_BANK_NAME, CBAD_CITY_CODE, CBAD_DIVISION,CBAD_ACNT_NAME,BANK_NAME,BR_BANK_BRANCH_CODE "
						...
						try {
							con = CommonUtils.getConnection();
							rs = handler.executeSelectStatement(qry, con, 
									new Object[]{submittedPOL_CUST_CODE});
							if(rs.next()){
								...
								/*PT_IL_POLICY_BEAN.setPOL_BANK_CODE(rs.getString("CBAD_BANK_CODE"));*/
						 ...
						 if(CommonUtils.isIN(CommonUtils.nvl(getPLAN_TYPE(),"X"), "L","H"))
							{
								...
								ResultSet resultset=new CRUDHandler().executeSelectStatement(query, 
										CommonUtils.getConnection(), new Object[]{PT_IL_POLICY_BEAN.getPOL_SYS_ID(),PT_IL_POLICY_BEAN.getPOL_END_CODE()});
								if(resultset.next())
								{
									function_ret=resultset.getString(1);
								}
					...
					/*Added by saritha on 12-07-2017 for Endowment Product & Education Product Issues*/
					 public void Endow_Product() {
						 ...
						 try {
							 ...
							 /*Commented and Modified by ganesh on 25-07-2017, as per andbarasi suggestion  ZBILQC-1732654*/
							/* if(("U".equals(getPLAN_TYPE()))&&("END".equals(getUnit_link_typ()))){
								 PT_IL_POLICY_BEAN.setPOL_LC_SUM_ASSURED(PT_IL_POLICY_BEAN.getPOL_FC_SUM_ASSURED());

							 }*/
							 
							 if(("U".equals(getPLAN_TYPE()) && ("END".equals(getUnit_link_typ()))) || ("U".equals(getPLAN_TYPE()) && ("EDU".equals(getUnit_link_typ())))){
								 /*
								  * MODIFIED BY AMEEN FOR KIC AS PER SIVA SUGG.
								  * PT_IL_POLICY_BEAN.setPOL_LC_SUM_ASSURED(PT_IL_POLICY_BEAN.getPOL_FC_SUM_ASSURED());*/
								 PT_IL_POLICY_BEAN.setPOL_LC_SUM_ASSURED(PT_IL_POLICY_BEAN.getPOL_FC_SUM_ASSURED()*PT_IL_POLICY_BEAN.getPOL_SA_EXCH_RATE());
								 /*Commented by saritha on 12-08-2017 for Endowment Product & Education Product Issues*/
								 //COMP_POL_LC_SUM_ASSURED.resetValue();
								 /*End*/
	...
	/*Added by saritha on 01-08-2017 for Endowment Product & Education Product issues*/
	public void setPremiumCalcType()
	{
		...
		try {
			...
			/*Added freezeflag condition by ganesh on 09-11-2017 to avoid enabling sum assured field for end product*/
			else if(("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_UL_PREM_CALC()))&&
					("END".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getUnit_link_typ())) && "N".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_FRZ_FLAG())){
				COMP_POL_FC_SUM_ASSURED.setDisabled(false);
				COMP_POL_ANN_BNF_AMT.setDisabled(true);
				COMP_POL_FC_MODAL_PREM.setDisabled(true);	
				COMP_POL_ANN_PAY_PERIOD.setDisabled(true);	
			...
			/*Added freezeflag condition by ganesh on 09-11-2017 to avoid enabling sum assured field for end product*/
				...
				if ("F".equals(dummyBean.getUI_M_COVER_SA_CALC())&&
					...
					/*if condition added by Ameen on 25-10-2019 for SARWA sugg. by Sivaram*/
	...
	public void setCOMP_POL_QUESTIONAIRE_BUTTON(
			HtmlCommandButton cOMP_POL_QUESTIONAIRE_BUTTON) {
	...
	public void enableDisable_FinancialQuest_Link() throws Exception{
		...
		try {
			...
			resultSet = new CRUDHandler().executeSelectStatement(C1, connection, new Object[]{PT_IL_POLICY_BEAN.getPOL_SYS_ID()});
			if(resultSet.next()){
	...
	public void validateUI_M_MOP_END(FacesContext context ,UIComponent component,Object object){
		...
		ArrayList<OracleParameter> list = new ArrayList<OracleParameter>();
 		try{
 			...
 			if(PT_IL_POLICY_BEAN.getPOL_END_TYPE()!=null && PT_IL_POLICY_BEAN.getPOL_END_TYPE().equalsIgnoreCase("007"))
			{
		...
		ArrayList<OracleParameter> list = new ArrayList<OracleParameter>();
 		try{
 			...
 			list = pkg_pilt002_apacnew.P_END_EFF_DT(PT_IL_POLICY_BEAN.getPOL_SYS_ID(),
 					 PT_IL_POLICY_BEAN.getPOL_END_DT(),PT_IL_POLICY_BEAN.getPOL_END_EFF_TYPE()
 					 ,null);
 			...
 			System.out.println("getPOL_END_EFF_FROM_DT                   "+PT_IL_POLICY_BEAN.getPOL_END_EFF_FROM_DT());
 			COMP_POL_END_EFF_FROM_DT.resetValue();
 		}catch (Exception e) {
 			e.printStackTrace();
 			throw new ValidatorException(new FacesMessage(e.getMessage()));
		...
		ResultSet rs = null;
		 try {
			 	rs = new CRUDHandler().executeSelectStatement(printQry, CommonUtils.getConnection(),
								new Object[]{"%"+PT_IL_POLICY_BEAN.getPOL_PROD_CODE()+"%","%"+PT_IL_POLICY_BEAN.getPOL_ADDL_STATUS()+"%",
								PT_IL_POLICY_BEAN.getPOL_APPRV_STATUS(),ds_type});
				if(rs.next()){			
					check = true;
				}
	...
	public void setCOMP_POL_CUST_EMP_NO_LABEL(
			HtmlOutputLabel cOMP_POL_CUST_EMP_NO_LABEL) {
	...
	public void validatePOL_CUST_EMP_NO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void setCOMP_UI_M_POL_BANK_DIVN_DESC(
			HtmlInputText cOMP_UI_M_POL_BANK_DIVN_DESC) {
		COMP_UI_M_POL_BANK_DIVN_DESC = cOMP_UI_M_POL_BANK_DIVN_DESC;
	}

	public void validatorUI_M_ACC_NAME(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void validatorPOL_CUST_BANK_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	/*public void bankAccDtlsCheck(){
		String qry = "SELECT 'X' FROM PM_CUST_BANK_ACNT_DTLS WHERE CBAD_CUST_CODE = ? AND CBAD_ACNT_NO = ? AND CBAD_ACNT_NAME = ?";
		ResultSet rs = null;
		try {
			
			rs = new CRUDHandler().executeSelectStatement(qry, CommonUtils.getConnection(), 
					new Object[]{PT_IL_POLICY_BEAN.getPOL_PREM_PAYER_CODE(),PT_IL_POLICY_BEAN.getPOL_CUST_BANK_CODE(),PT_IL_POLICY_BEAN.getUI_M_ACC_NAME()});
			if(!rs.next()){
				throw new Exception("Bank Dtls:Invalid Account Number and Account Name");
			}
			 ...
			 /*End*/
				 		try{
				 			rs = new CRUDHandler().executeSelectStatement(selectQuery, CommonUtils.getConnection(),
				 							new Object[]{PT_IL_POLICY_BEAN.getPOL_BANK_CODE(),submittedValue,PT_IL_POLICY_BEAN.getPOL_PREM_PAYER_CODE()});
				 			if(rs.next()){
				 				/*Modified by ganesh on 06-11-2017 as suggested by ajoy */
				 				//PT_IL_POLICY_BEAN.setPOL_CUST_BANK_CODE(rs.getLong("CBAD_ACNT_NO"));
				 				PT_IL_POLICY_BEAN.setPOL_CUST_BANK_CODE(rs.getString("CBAD_ACNT_NO"));
	...
	public String getBranchDesc() throws Exception {
		 ...
		 try {
			 connection = CommonUtils.getConnection();
			 resultSet = new CRUDHandler().executeSelectStatement(query,
					 connection, new Object[] { PT_IL_POLICY_BEAN.getPOL_BANK_CODE(), PT_IL_POLICY_BEAN.getPOL_BANK_DIVN()});
			 if (resultSet.next()) {
				 desc = resultSet.getString(1);
			 }
		 } catch (DBException e) {
	...
	public void validatorPOL_DEBIT_DAY(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void checkPolTerm() throws Exception {
		...
		try {
			 ...
			 * 
			 * rs = new CRUDHandler().executeSelectStatement(matQry, CommonUtils.getConnection(),new Object[]{PT_IL_POLICY_BEAN.getPOL_PROD_CODE()});*/
			
			rs = new CRUDHandler().executeSelectStatement(matQry, CommonUtils.getConnection(),new Object[]{PT_IL_POLICY_BEAN.getPOL_PLAN_CODE()});
			if(rs.next()){
			...
			if(pol_age > matAge){
				//throw new Exception("Maximum Maturity Age exceeds as per Setup ,Policy Term Should be lesser or equalto : " + PT_IL_POLICY_BEAN.getUI_M_POL_PERIOD());
				
				throw new Exception("Maximum Maturity Age exceeds as per Setup ,Policy Term Should be lesser or equalto : " + pol_period);
			}
	...
	public void addCoverRider() throws Exception {
		...
		try {
			...
			connection = CommonUtils.getConnection();
			resultset = new CRUDHandler().executeSelectStatement(coverCodequery, connection,new Object[]{PT_IL_POLICY_BEAN.getPOL_SYS_ID(),PT_IL_POLICY_BEAN.getPOL_SYS_ID()});
			if(resultset.next()){
				compositeAction.getWizard().enableWizardItem("PILT002_APAC_PT_IL_POL_FUNERAL_MEMB_DTLS");
	...
	public void getAssuredDltPanel(){
		...
		try{
			...
			if(rs.next()){
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_CODE(rs.getString("CONT_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_NAME(rs.getString("CONT_NAME"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_REF_ID1(rs.getString("CONT_REF_ID1"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_REF_ID2(rs.getString("CONT_REF_ID2"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_DOB(rs.getDate("CONT_DOB"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_CATG_CODE(rs.getString("CONT_CATG_CODE"));
				catgRS=new CRUDHandler().executeSelectStatement(catgQry, CommonUtils.getConnection(), new Object[]{
					compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().getCONT_CATG_CODE()});
				if(catgRS.next()){
					compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setUI_M_CONT_CATG_CODE_DESC(catgRS.getString("PS_CODE_DESC"));
				}
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_ADDR1(rs.getString("CONT_ADDR1"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_ADDR2(rs.getString("CONT_ADDR2"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_ADDR3(rs.getString("CONT_ADDR3"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_CITY_CODE(rs.getString("CONT_CITY_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_CITY(rs.getString("CONT_CITY"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_COUNT_CODE(rs.getString("CONT_COUNT_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_COUNTRY(rs.getString("CONT_COUNTRY"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_POSTAL_CODE(rs.getString("CONT_POSTAL_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_MOB_AREA_CODE(rs.getString("CONT_MOB_AREA_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_MOBILE_NO(rs.getString("CONT_MOBILE_NO"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_TEL_AREA_CODE(rs.getString("CONT_TEL_AREA_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_PHONE(rs.getString("CONT_PHONE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_FAX_AREA_CODE(rs.getString("CONT_FAX_AREA_CODE"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_FAX(rs.getString("CONT_FAX"));
				compositeAction.getPM_IL_CONTRACTOR_ACTION_QE_BEAN().getPM_IL_CONTRACTOR_QE_BEAN().setCONT_EMAIL_ID(rs.getString("CONT_EMAIL_ID"));
	...
	public String approveLinkDisable() throws Exception {
		...
		System.out.println("enters into approveLinkDisable                    "+compositeAction.getPT_IL_POLICY_ACTION_BEAN().
				getPT_IL_POLICY_BEAN().getPOL_SYS_ID());
		...
		try {
			...
			resultset = new CRUDHandler().executeSelectStatement(query1, connection,new Object[] {compositeAction.getPT_IL_POLICY_ACTION_BEAN().
					getPT_IL_POLICY_BEAN().getPOL_SYS_ID()});
			
			if(resultset.next()){
			
			resultSet1 = new CRUDHandler().executeSelectStatement(query2, connection,new Object[] {compositeAction.getPT_IL_POLICY_ACTION_BEAN().
					getPT_IL_POLICY_BEAN().getPOL_SYS_ID(),compositeAction.getPT_IL_POLICY_ACTION_BEAN().
					getPT_IL_POLICY_BEAN().getPOL_SYS_ID()});
			...
			if(resultSet1.next()){
				...
				/*Commentted &Modified by saritha on 23-04-2019 for KIC (Issue :Reinstatement Endorsement passed approve button disable) as per siva sir sugg.*/  
				
				/*else if(pdd_status.equalsIgnoreCase("DP03") && (compositeAction.getPT_IL_POLICY_ACTION_BEAN().
						getPT_IL_POLICY_BEAN().getPOL_END_NO_IDX() == 0))*/
					
				else if(pdd_status.equalsIgnoreCase("DP03") && (compositeAction.getPT_IL_POLICY_ACTION_BEAN().
							getPT_IL_POLICY_BEAN().getPOL_END_NO_IDX() == 0)||compositeAction.getPT_IL_POLICY_ACTION_BEAN().
							getPT_IL_POLICY_BEAN().getPOL_END_NO_IDX() > 0 )
				{
		...
		try {
			...
			if(resultset.next()){
				...
				if(PS_VALUE.equalsIgnoreCase("1"))
				{
					...
					/*If and else Added by Janani on 12.10.2018 for KIC
					Issue : Disable Dispatch dtls link at Proposal level*/
	...
	public String getAutoUnderwriting() throws Exception {
		...
		try {
			...
			resultSet1 = new CRUDHandler().executeSelectStatement(query1, connection,new Object[]{compositeAction.getPT_IL_POLICY_ACTION_BEAN().
	...
	public void setCOMP_POL_REG_EXCESS_PREM_LABEL(
			HtmlOutputLabel cOMP_POL_REG_EXCESS_PREM_LABEL) {
	...
	public void setCOMP_POL_RETURN_VAL_LABEL(
			HtmlOutputLabel cOMP_POL_RETURN_VAL_LABEL) {
	...
	public void validatePOL_REG_EXCESS_PREM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		try {
	...
	public void validatePOL_RETURN_VAL(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		try {
	...
	public void setCOMP_UI_M_POL_REG_EXCESS_PREM(
			HtmlInputText cOMP_UI_M_POL_REG_EXCESS_PREM) {
	...
	public void setCOMP_POL_CARD_EXP_DT_LABEL(
			HtmlOutputLabel cOMP_POL_CARD_EXP_DT_LABEL) {
	...
	public void validatePOL_CVV_NO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void validatePOL_CARD_EXP_DT_MM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void validatePOL_CARD_EXP_DT_YY(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			String card_exp_dt = PT_IL_POLICY_BEAN.getPOL_CARD_EXP_DT_MM()+"/"+PT_IL_POLICY_BEAN.getPOL_CARD_EXP_DT_YY();
	...
	public void validatePOL_RES_ADDRESS_1(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "POL_RES_ADDRESS_1", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_RES_ADDRESS_2(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "POL_RES_ADDRESS_2", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_RES_ADDRESS_3(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "POL_RES_ADDRESS_3", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_MOBILE_NO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "POL_MOBILE_NO", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_RES_PHONE_NO(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil.getWarningForProcedure(CommonUtils
						.getConnection(), "POL_RES_PHONE_NO", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void setUpdatedCivilIID(){
		...
		try {
			...
			if("C".equalsIgnoreCase(compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getCustAssured())){
				...
				if(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1()!=null && PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2()!=null &&
						PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1().equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2())){
					this.PT_IL_POLICY_BEAN.setPOL_ASSRD_REF_ID1(compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_REF_ID1());
					this.PT_IL_POLICY_BEAN.setPOL_ASSRD_REF_ID2(compositeAction.getPM006_QE_CUSTOMER_ACTION_BEAN().getPM006_QE_CUSTOMER_BEAN().getCUST_REF_ID1());
	...
	public void getCoverSACalc() throws Exception {
		...
		try {
			...
			if(!"A".equalsIgnoreCase(cvr_sa_calc)||("Y".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_FRZ_FLAG()) && "A".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getPT_IL_POLICY_BEAN().getPOL_APPRV_STATUS())))
			{
			...
			/*
			 * 
			 * commented by Dhinesh on 29-05-2018 for funeral Sub plan code issue
			 * 
	...
	public void pol_period_disable() throws Exception {
		...
		try {
			...
			if(resultset.next()){
				...
				System.out.println("PROD_CALC_TERM_YN is                 "+PROD_CALC_TERM_YN+"    PROD_PREM_PAYING_YRS    "+PROD_PREM_PAYING_YRS);
...
/*Added by Janani on 25.06.2018 for  FSD_IL_FLA_006_Monetary Endorsement Module*/
	...
	public void PremSAcheck()
	{
		...
		try {
			...
			/*MOdified by Janani on 23.07.2018 for SA field enabled after Freeeze Yes*/
			/*else if(("A".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_UL_PREM_CALC()))&&
					("END".equalsIgnoreCase(compositeAction.getPT_IL_POLICY_ACTION_BEAN().getUnit_link_typ())))*/
	...
	public void setCOMP_UI_M_POBH_BROKER_CODE_LABEL(
			HtmlOutputLabel cOMP_UI_M_POBH_BROKER_CODE_LABEL) {
	...
	public void setCOMP_UI_M_POBH_BROKER_CODE(
			HtmlInputText cOMP_UI_M_POBH_BROKER_CODE) {
	...
	public void setCOMP_UI_M_POBH_BROKER_CODE_DESC(
			HtmlInputText cOMP_UI_M_POBH_BROKER_CODE_DESC) {
		COMP_UI_M_POBH_BROKER_CODE_DESC = cOMP_UI_M_POBH_BROKER_CODE_DESC;
	}

	public void validateUI_M_POBH_BROKER_CODE(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		...
		try {
			...
			if("O".equalsIgnoreCase(P_PROD_POL_APPROVAL_YN)){
				...
				compositeAction.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN().getPT_IL_POL_BROKER_HEAD_BEAN().setPOBH_BROKER_CODE(PT_IL_POLICY_BEAN.getUI_M_POBH_BROKER_CODE());
				compositeAction.getPT_IL_POL_BROKER_HEAD_ACTION_BEAN().getPT_IL_POL_BROKER_HEAD_BEAN().setPOBH_SHARE_PERC(100.0);
	...
	public void getCountryCodeDesc() {
		...
		// String query = "SELECT PC_CODE,PC_DESC FROM PM_CODES WHERE PC_TYPE = 'COUNTRY' and ";
	...
	/*Fidelity feature taken for kic added by Pidugu Raj on 20-09-2018 (FSD_IL_FLA_009)*/	
		...
		public void setCOMP_PDU_UTIL_AMT(HtmlInputText cOMP_PDU_UTIL_AMT) {
		  ...
		  private HtmlOutputLabel COMP_UI_M_PDU_SUS_AMT_LABEL;
			...
			public void setCOMP_UI_M_PDU_SUS_AMT_LABEL(
					HtmlOutputLabel cOMP_UI_M_PDU_SUS_AMT_LABEL) {
		...
		public void getPol_receipt_dtls() {
			 ...
			 try {
				 ...
				 connection = CommonUtils.getConnection();
				 rs = new CRUDHandler().executeSelectStatement(query, connection,  new Object[]{PT_IL_POLICY_BEAN.getPOL_SYS_ID()});
			...
			System.out.println("enters into showPol_receipt_dtlss");
			 ...
			 try {
				...
				if(IL_DEP_COLL.equalsIgnoreCase("2"))
				{
					...
					{
						/*MOdified by Janani on 24.08.2018 for FSD_IL_FLA_009 as suggested by Prasanth*/
	...
	/*Added by Sivarajan on 29-01-2019 for cust code and assured code validation*/
	public boolean validateCivilId(PT_IL_POLICY PT_IL_POLICY_BEAN){
		...
		try{
			...
			if(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1() != null){
				rs = new CRUDHandler().executeSelectStatement(query, connection, new Object[] {PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID1(),PT_IL_POLICY_BEAN.getPOL_CUST_CODE()});
				if(rs.next()){
					returnVal = true;
				}else{
					return false;
			...
			if(PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2() != null){
				rs = new CRUDHandler().executeSelectStatement(query, connection, new Object[] {PT_IL_POLICY_BEAN.getPOL_ASSRD_REF_ID2(),PT_IL_POLICY_BEAN.getPOL_CONT_CODE()});
				if(rs.next()){
					returnVal = true;
				}else{
					return false;
	...
	public void setCOMP_POL_BNF_ESC_YN_LABEL(
			HtmlOutputLabel cOMP_POL_BNF_ESC_YN_LABEL) {
	...
	public void setCOMP_POL_ADHOC_PREM_YN_LABEL(
			HtmlOutputLabel cOMP_POL_ADHOC_PREM_YN_LABEL) {
	...
	public void setCOMP_POL_ADHOC_LC_PREM_LABEL(
			HtmlOutputLabel cOMP_POL_ADHOC_LC_PREM_LABEL) {
	...
	public void setCOMP_POL_CASHBACK_YN_LABEL(
			HtmlOutputLabel cOMP_POL_CASHBACK_YN_LABEL) {
	...
	public void setCOMP_POL_CASHBACK_PREC_LABEL(
			HtmlOutputLabel cOMP_POL_CASHBACK_PREC_LABEL) {
	...
	public void setCOMP_POL_CASHBACK_ST_YR_LABEL(
			HtmlOutputLabel cOMP_POL_CASHBACK_ST_YR_LABEL) {
	...
	public void validatePOL_BNF_ESC_YN(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			
			PT_IL_POLICY_BEAN.setPOL_BNF_ESC_YN((String) value);
			if(PT_IL_POLICY_BEAN.getPOL_BNF_ESC_YN()!=null && "Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_BNF_ESC_YN())){
				COMP_POL_BNF_ESC_PERC.setDisabled(false);
			}else{
				COMP_POL_BNF_ESC_PERC.setDisabled(true);
			}
	...
	public void validatePOL_ADHOC_PREM_YN(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			
			PT_IL_POLICY_BEAN.setPOL_ADHOC_PREM_YN((String) value);
			if(PT_IL_POLICY_BEAN.getPOL_ADHOC_PREM_YN()!=null && "Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_ADHOC_PREM_YN())){
			...
			try {
				ErrorHelpUtil
				.getWarningForProcedure(CommonUtils.getConnection(),
						"POL_ADHOC_PREM_YN", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_ADHOC_LC_PREM(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			...
			try {
				ErrorHelpUtil
				.getWarningForProcedure(CommonUtils.getConnection(),
						"POL_ADHOC_LC_PREM", getWarningMap());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
	...
	public void validatePOL_CASHBACK_YN(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
			
			PT_IL_POLICY_BEAN.setPOL_CASHBACK_YN((String) value);
			if(PT_IL_POLICY_BEAN.getPOL_CASHBACK_YN() != null && "Y".equalsIgnoreCase(PT_IL_POLICY_BEAN.getPOL_CASHBACK_YN())){
	...
	public void validatePOL_CASHBACK_PREC(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
	...
	public void validatePOL_CASHBACK_ST_YR(FacesContext facesContext,
			UIComponent component, Object value) throws ValidatorException {
		CommonUtils.clearMaps(this);
		try {
