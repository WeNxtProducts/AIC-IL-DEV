...
public class PT_IL_SURR_MAT_VALUES_DELEGATE {
	public void executeSelectStatement(
		...
		String selectStatement = "SELECT ROWID, PT_IL_SURR_MAT_VALUES.* FROM PT_IL_SURR_MAT_VALUES WHERE SMV_POL_SYS_ID = ? AND SMV_TYPE IN ('S','R','M','P') ORDER BY SMV_SYS_ID ";
		//end
		...
		try {
			...
			String C6 = "UPDATE PT_IL_SURR_MAT_VALUES SET SMV_LOAN_INT_YN ='Y' WHERE SMV_POL_SYS_ID = ? AND SMV_TYPE IN ('S','R','M','P')";
