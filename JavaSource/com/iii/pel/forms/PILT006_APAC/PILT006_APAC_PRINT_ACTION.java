...
public class PILT006_APAC_PRINT_ACTION extends CommonReportAction{
	...
	private final static ResourceBundle resourceBundle1 = ResourceBundle
			.getBundle("Report_ID");
		...
		HttpServletResponse response = null;
			...
			if (getRedirectUrl() != null && !approvalFlagStatus) {
				...
				{*/
					...
					url=new StringBuffer(getRedirectUrl());
					System.out.println("this is url"+url.toString());
					if(report_id.equals("AICREP016")){
						url = new StringBuffer();
						url.append(resourceBundle1.getString("Jasper_newServeletUrl"));
//						url.append(request.getContextPath() + "/jasperreport?");
					}
