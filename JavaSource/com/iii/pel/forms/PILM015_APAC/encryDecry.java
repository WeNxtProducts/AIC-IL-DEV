...
//		String driver_url = PremiaCryptograph.encrypt(ConnectionManager.ENCRYPTION_KEY, "oracle:thin:@192.168.10.2:1521:ORAUAT");
		String user_name = PremiaCryptograph.encrypt(ConnectionManager.ENCRYPTION_KEY, "WN_AIC_UAT");
		String user_pwd = PremiaCryptograph.encrypt(ConnectionManager.ENCRYPTION_KEY, "WN_AIC_UAT");
