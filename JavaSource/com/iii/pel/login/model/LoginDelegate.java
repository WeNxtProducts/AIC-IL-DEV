...
public class LoginDelegate {
	...
	public String executeSelectStatement() throws Exception {
		...
		try {
			...
			if (!connection.isClosed() && connection != null) {
				System.out.println("----------------LoginDele-----connclose2");
				connection.close();
			}
		}
	...
	public String executeDefaultBranch(String userName) throws Exception {
		...
		try {
			...
			CommonUtils.closeCursor(resultSet);
			if (!connection.isClosed() && connection != null) {
				System.out.print("----------------LoginDele-----connclose1");
				connection.close();
			}
		}
	...
	public ArrayList<OracleParameter> P_USER_PWD_ENCRYPT(String P_USERID, Object P_PASSWORD, Connection connection)
		...
		try {
			...
			OracleParameter param1 = new OracleParameter("IN1", OracleParameter.DATA_TYPE.STRING,
					OracleParameter.DIRECTION_TYPE.IN, P_USERID);
			parameterList.add(param1);
			OracleParameter param2 = new OracleParameter("IN2", OracleParameter.DATA_TYPE.STRING,
					OracleParameter.DIRECTION_TYPE.IN, P_PASSWORD);
			parameterList.add(param2);

			OracleProcedureHandler procHandler = new OracleProcedureHandler();
			outputList = procHandler.executeProc(parameterList, connection, "P_USER_PWD_ENCRYPT");
		} catch (Exception e) {
